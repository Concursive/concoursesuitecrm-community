 ...
 *
 * NOTES: Can be expanded to account for complex cases like Account -> Contact -> Opportunity -> Tasks <br>
 * by allowing for multiple object passing in the tag.
 * For example <dhv:sharing name=<CallDetails, ContactDetails, OpportunityHeader> action=<VIEW>/>
 *
 *@author     Mathur
...
public class SharingHandler extends TagSupport {
   ...
   *  Can be expanded to use for other Business Objects like Opportunities as well
   *

...
/**
 * This tag displays a dynamic javascript tree for product categories
 *
 * @author Olga.Kaptyug
 * @created Jun 20, 2006
 */
public class ProductCategoryTreeHandler extends TagSupport {
  ...
  public int drawTree(String parentId) throws JspException {
    try {
      ...
      if (pcList != null) {
        if (home != null) {
          out.println("<div>");
          out.println("<img src=\"images/stock_folder-23.gif\">");
          out.print("Home");
          out.println("</div>");
        }
      ...
      while (iter.hasNext()) {
        ...
        if (category.getChildCount() > 0) {
          ...
          if (category.getChildList().size() > 0) {
            ...
            out.print("&parentId=" + category.getId() + "\" target=\"frame_" + category.getId() + "\"><img id=\"img_" + category.getId() + "\" src=\"");
            ...
            //out.println("<iframe name=\"frame_" + category.getId() + "\" id=\"frame_" + category.getId() + "\"></iframe>");
            out.println("<iframe src=\"empty.html\" name=\"frame_" + category.getId() + "\" id=\"frame_" + category.getId() + "\" style=\"visibility:hidden\" height=\"0\"></iframe>");

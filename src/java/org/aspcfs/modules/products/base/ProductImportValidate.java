...
public class ProductImportValidate {
   ...
   */
  public void setProductCatalogImport(ProductCatalogImport tmp) {
    this.productImport = tmp;
  }
   ...
   */
  public ProductCatalogImport getContactImport() {
  ...
  public void autoMapProperties() {
    ...
    try {
      CFSFileReader fileReader = new CFSFileReader(
          filePath, productImport.getFileType());

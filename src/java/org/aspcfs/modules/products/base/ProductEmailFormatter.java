    ...
    Template template = new Template();
		...
		if (showPriceSavings) {
			if (productCatalog.getActivePrice() != null) {
				...
				additionalInformation.append(CurrencyFormat.getCurrencyString(new Double(productCatalog.getActivePrice().getPriceAmount()), locale));
				if (productCatalog.getActivePrice().getMsrpAmount() > productCatalog.getActivePrice().getPriceAmount()) {
					...
					additionalInformation.append(CurrencyFormat.getCurrencyString(new Double(savings), locale));
				}
			} else {

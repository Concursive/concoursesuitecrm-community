...
public final class ProductCatalogOptions extends CFSModule {
  ...
  public String executeCommandList(ActionContext context) {
    ...
    PagedListInfo optionListInfo = this.getPagedListInfo(
        context, "ProductCatalogOptionListInfo");
    try {
      ...
      optionListInfo.setLink(
          "ProductCatalogOptions.do?command=List&moduleId=" + moduleId + "&productId=" + productId + "&categoryId=" + categoryId);
  ...
  public String executeCommandDetails(ActionContext context) {
    ...
    try {
      ...
      context.getRequest().setAttribute(
          "allowMultiplePrices", new String(
              allowMultiplePrices ? "true" : "false"));
  ...
  public String executeCommandOptionList(ActionContext context) {
    ...
    try {
      ...
      ProductOptionList optionList = new ProductOptionList();
      optionListInfo.setLink(
          "ProductCatalogOptions.do?command=OptionList&moduleId=" + moduleId + "&catalogId=" + catalogId + "&configId=" + configId);
      optionList.setPagedListInfo(optionListInfo);
    ...
    try {
      ...
      if (dependencies.canDelete()) {
        htmlDialog.addButton(
            systemStatus.getLabel("button.deleteAll"), "javascript:window.location.href='ProductCatalogOptions.do?command=Delete&optionId=" + optionId + "&action=delete&return=" + returnUrl + "&moduleId=" + (moduleId != null ? moduleId : "") + "&categoryId=" + (categoryId != null ? categoryId : "") + "&productId=" + (productId != null ? productId : "") + "'");
      }
      htmlDialog.addButton(
    ...
    if (errorMessage == null) {
      ...
      context.getRequest().setAttribute(
          "actionError", this.getSystemStatus(context).getLabel(
              "object.validation.actionError.productOptionDeletion"));
      context.getRequest().setAttribute("refreshUrl", returnUrl);
      return ("DeleteError");
    }
  }
    ...
    try {
      ...
      if (context.getRequest().getParameter("action") != null) {
        ...
        if (context.getRequest().getAttribute("productOption") == null) {
          ...
          productOption = (ProductOption) context.getRequest().getAttribute(
              "productOption");
        }

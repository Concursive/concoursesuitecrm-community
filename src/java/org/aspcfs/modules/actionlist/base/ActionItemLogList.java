...
public class ActionItemLogList extends ArrayList {
  ...
  public void buildList(Connection db) throws SQLException {
    ...
    sqlSelect.append(
        "al.log_id, al.item_id, al.link_item_id, al." + DatabaseUtils.addQuotes(db, "type")+ ", " +
  ...
  public static ActionList isItemLinked(Connection db, int linkItemId, int type) throws SQLException {
    ...
    PreparedStatement pst = db.prepareStatement(
        ...
        "WHERE al.link_item_id = ? AND al." + DatabaseUtils.addQuotes(db, "type")+ " = ? AND ai.item_id = al.item_id ");

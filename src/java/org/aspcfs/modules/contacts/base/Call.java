...
public class Call extends GenericBean {
  ...
  public boolean delete(Connection db) throws SQLException {
    ...
    // Delete any history relationship that might exist
  ...
  public String generateWebcalEvent(TimeZone tz, Timestamp created, int type) {
    ...
    if (type == COMPLETE_FOLLOWUP_PENDING) {
      webcal.append(
          "UID:www.concursive.com-myhomepage-pending-calls-" + this.getId() + CRLF);
    } else if (type == COMPLETE) {
      webcal.append(
          "UID:www.concursive.com-myhomepage-completed-calls-" + this.getId() + CRLF);
    }

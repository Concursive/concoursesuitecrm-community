...
public final class ExternalContactsOpps extends CFSModule {
  ...
  public String executeCommandModifyComponent(ActionContext context) {
    ...
    try {
      ...
      if (!hasPermission(
          context, "contacts-external_contacts-opportunities-edit") || (thisContact.getOrgId() > 0 &&
  ...
  public String executeCommandComponentHistory(ActionContext context) {
    ...
    componentHistoryListInfo.setLink(
        "ExternalContactsOppComponents.do?command=ComponentHistory&contactId=" + contactId +
        "&id=" + componentId + RequestUtils.addLinkParams(
        context.getRequest(), "viewSource|popup"));

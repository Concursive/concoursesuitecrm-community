...
public final class SalesImports extends CFSModule {
  ...
  public String executeCommandView(ActionContext context) {
    ...
    Connection db = null;
    PagedListInfo pagedListInfo = this.getPagedListInfo(context, "SalesImportListInfo");
        ...
        if (isValid) {
          ...
          if (contactRecordInserted) {
            if ((Object) parts.get("id") instanceof FileInfo) {
              ...
              thisItem.setLinkModuleId(Constants.IMPORT_SALES);
  ...
  public String executeCommandConfirmDelete(ActionContext context) {
    ...
    try {
      ...
      if (dependencies.size() == 0) {
        ...
        htmlDialog.setDeleteUrl("javascript:window.location.href='SalesImports.do?command=Delete&importId=" + importId + "'");
      } else {
        htmlDialog.setHeader(systemStatus.getLabel("confirmdelete.header"));
        htmlDialog.addButton(systemStatus.getLabel("button.deleteAll"), "javascript:window.location.href='SalesImports.do?command=Delete&importId=" + importId + "'");
  ...
  public String executeCommandDelete(ActionContext context) {
    ...
    try {
      ...
      if (recordDeleted > 0) {
        //delete the files
        FileItem importFile = new FileItem(db, thisImport.getId(), Constants.IMPORT_SALES);
    ...
    context.getRequest().setAttribute("refreshUrl", "SalesImports.do?command=View");
  ...
  public String executeCommandDownload(ActionContext context) {
    ...
    try {
      ...
      thisItem = new FileItem(db, Integer.parseInt(itemId), Integer.parseInt(importId), Constants.IMPORT_SALES);
      if (version != null) {
    ...
    try {
      ...
      if (version == null) {
        ...
        if (fileDownload.fileExists()) {
          ...
          db = null;
          System.err.println("SalesImports-> Trying to send a file that does not exist");
  ...
  public String executeCommandViewResults(ActionContext context) {
    ...
    Connection db = null;
    String importId = context.getRequest().getParameter("importId");
    PagedListInfo pagedListInfo = this.getPagedListInfo(context, "SalesImportResultsInfo");
    pagedListInfo.setLink("SalesImports.do?command=ViewResults&importId=" + importId);
    try {
      db = this.getConnection(context);
      ContactImport thisImport = new ContactImport(db, Integer.parseInt(importId));
      context.getRequest().setAttribute("ImportDetails", thisImport);

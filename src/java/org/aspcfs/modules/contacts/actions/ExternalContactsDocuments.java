 ...
 * @version $Id: ExternalContactsDocuments.java ,v 1.0 2006/12/11  vadim.vishnevsky@corratech.com
 */
public final class ExternalContactsDocuments extends CFSModule {
  ...
  public String executeCommandView(ActionContext context) {
    if (!(hasPermission(context, "contacts-external_contacts-documents-view"))) {
  ...
  public String executeCommandAdd(ActionContext context) {
    ...
    if (!(hasPermission(context, "contacts-external_contacts-documents-add"))) {
      return ("PermissionError");
    }
    Exception errorMessage = null;
    Connection db = null;
    ...
    try {
      if (version == null) {
        ...
        if (fileDownload.fileExists()) {
          ...
          db = null;
          System.err.println(
              "ContactsDocuments-> Trying to send a file that does not exist");
  ...
  public String executeCommandModify(ActionContext context) {
    if (!hasPermission(context, "contacts-external_contacts-documents-edit")) {
      return ("PermissionError");
    }
    Exception errorMessage = null;
    String itemId = (String) context.getRequest().getParameter("fid");
  ...
  public String executeCommandDelete(ActionContext context) {
    if (!hasPermission(context, "contacts-external_contacts-documents-delete")) {
      return ("PermissionError");
    }
    Exception errorMessage = null;

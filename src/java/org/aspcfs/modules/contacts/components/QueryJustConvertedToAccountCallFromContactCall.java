 ...
 * @created Sep 15, 2006
 */
public class QueryJustConvertedToAccountCallFromContactCall extends
    ObjectHookComponent implements ComponentInterface {

  /**
   * Gets the description attribute of the
   * QueryJustConvertedToAccountCallFromContactCall object
   * 
   * @return The description value
   */
  public String getDescription() {
    return "Determine if the current call object is associated with a account and the previous call object is not";
  }
  ...
  public boolean execute(ComponentContext context) {
    ...
    return ((thisCall.getOrgId() != -1 && thisCall.getContactId() == -1 && thisCall
        .getFollowupContactId() == -1) && (previousCall.getContactId() != -1 || previousCall

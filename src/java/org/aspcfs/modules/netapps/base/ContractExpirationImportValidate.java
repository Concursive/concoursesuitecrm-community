 ...
 *@version    $Id$
 */
public class ContractExpirationImportValidate {
  ...
  /**
   *  Constructor for the ContractExpirationImportValidate object
   */
  public ContractExpirationImportValidate() { }


  /**
   *  Sets the propertyMapList attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Sets the filePath attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Sets the fieldMappings attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the fieldMappings attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Sets the sampleRecords attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Sets the contractExpirationImport attribute of the ContractExpirationValidate
   *  object
   *
   *@param  tmp  The new contractExpirationImport value
   */
  public void setContractExpirationImport(ContractExpirationImport tmp) {
    this.contractExpirationImport = tmp;
  }


  /**
   *  Sets the errors attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the errors attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the generalErrors attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the fieldErrors attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the sampleRecords attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the contractExpirationImport attribute of the ContractExpirationValidate
   *  object
   *
   *@return    The contractExpirationImport value
   */
  public ContractExpirationImport getContractExpirationImport() {
    return contractExpirationImport;
  }


  /**
   *  Gets the propertyMap attribute of the ContactExpirationImportValidate object
   *
  ...
  /**
   *  Gets the filePath attribute of the ContactExpirationImportValidate object
   *
  ...
  public void autoMapProperties() {
    ...
    try {
      CFSFileReader fileReader = new CFSFileReader(filePath, contractExpirationImport.getFileType());
      ...
      System.out.println("ContactExpirationImportValidate -> EXCEPTION " + e);
    }
  }
  ...
  public void buildImportSample(int count) {
    try {
      ...
      System.out.println("ContactExpirationImportValidatea -> Sampling Exception " + e);
    }
  }
  ...
  public void validate(HttpServletRequest request) {
    ...
    try {
      ...
      e.printStackTrace();
      System.out.println("ContactExpirationImportValidate -> Sampling Exception " + e);
    }
  }

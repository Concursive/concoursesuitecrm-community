...
public class DemoData {
  ...
  public static boolean install(Connection db, DemoAccount demoAccount) throws SQLException {
    ...
    //role.addPermission(db, Permission.lookupId(db, "contacts-external_contacts-imports"), true, true, true, true);
    ...
    //role.addPermission(db, Permission.lookupId(db, "accounts-accounts-contact-updater"), false, true, false, false);
    ...
    //role.addPermission(db, Permission.lookupId(db, "contacts-external-contact-updater"), false, true, false, false);

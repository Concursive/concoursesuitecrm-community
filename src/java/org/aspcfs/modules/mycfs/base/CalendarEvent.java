...
public class CalendarEvent implements Comparable {
  ...
  public String getLink() {
    ...
    if (category.equalsIgnoreCase("Opportunity")) {
      ...
      return "<a href=\"javascript:popURL('LeadsCalls.do?command=Modify&id=" + idsub + "&headerId=" + id + "&popup=true&return=Calendar','CFS_Opportunity','550','375','yes','yes');\" style=\"text-decoration:none;color:black;\" onMouseOver=\"this.style.color='blue';window.status='Update this Call';return true;\" onMouseOut=\"this.style.color='black';window.status='';return true;\">";

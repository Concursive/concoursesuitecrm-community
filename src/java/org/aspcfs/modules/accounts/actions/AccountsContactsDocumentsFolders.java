 ...
 * @version $Id: AccountsContactsDocumentsFolders.java zhenya.zhidok $
 * @created 28.12.2006
 *
 */
...
public final class AccountsContactsDocumentsFolders extends CFSModule {
  ...
  public String executeCommandAdd(ActionContext context) {
    ...
    try {
      ...
      Organization thisOrganization = new Organization(db, contactDetails.getOrgId());
  ...
  public String executeCommandSave(ActionContext context) {
    ...
    try {
      ...
      thisOrganization = new Organization(db, contactDetails.getOrgId());
      context.getRequest().setAttribute("OrgDetails", thisOrganization);
  ...
  public String executeCommandSaveMove(ActionContext context) {
    ...
    try {
      ...
      if (folderId != 0 && folderId != -1) {
        ...
        thisHierarchy.setLinkModuleId(Constants.CONTACTS);

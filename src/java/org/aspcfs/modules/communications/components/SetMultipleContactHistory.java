 ...
 * @created May 27, 2005
 */
public class SetMultipleContactHistory extends ObjectHookComponent implements ComponentInterface {
  ...
  /**
   * Gets the description attribute of the SetMultipleContactHistory object
   *

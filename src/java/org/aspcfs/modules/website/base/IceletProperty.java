...
public class IceletProperty extends GenericBean {
  ...
  public final static String ROWS_COLUMNS_COUNT = "rowColumnsCount";
  public final static String CONFIGURE_SPREADSHEET = "configureSpreadSheet";
  public final static String PREVIEW = "preview";
  public final static String HIDDEN_FILENAME = "hiddenFileName";
  public final static String GRAPH_SIZE = "graphSize";
  public final static String GRAPH_TIMESTAMP = "FileDeleteTimeStamp";
			...
			if (this.getValue() != null && !"".equals(this.getValue()) && !"-1".equals(this.getValue())) {
				...
				while(minorAxisToken.hasMoreTokens()){
					...
					while(minorAxisFieldToken.hasMoreTokens()){
						...
						if (customField != null && customField.getName() != null) {
							minorAxisEdit.append("<option value='"+optionValue+"'"+">");

...
public class FolderGraphPortlet extends GenericPortlet {
  ...
  private String minorAxisFieldName1 = null;
  private String minorAxisFieldName2 = null;
  ...
  private void drawGraph(RenderRequest request, List folderDataList) {
    ...
    if (minorAxisFieldName.indexOf(",") > -1) {
      ...
      while (strToken.hasMoreTokens()) {
        minorAxisFieldName1 = strToken.nextToken().trim();
        minorAxisFieldName2 = strToken.nextToken().trim();
      }
    }
      ...
      if (checkFileName != null) {
        ...
        if (graphType != null) {
          ...
          if (graphType.equalsIgnoreCase("Line") && minorAxisFieldId.indexOf(",") == -1) {        // Line Chart
            ...
            DefaultCategoryDataset collection = createLineGraphCategoryDataset(folderDataList);
          ...
          if (graphType.equalsIgnoreCase("Line") && minorAxisFieldId.indexOf(",") > -1) {      // Combined Line Chart
            DefaultCategoryDataset collection = createCombinedLineGraphCategoryDataset(folderDataList);

            chart = ChartFactory.createLineChart(
                "FolderGraph",                       // chart title
                majorAxisFieldName,                       // domain axis label
                minorAxisFieldName1 + " / " + minorAxisFieldName2,  // range axis label
                collection,                               // data
                PlotOrientation.VERTICAL,                // orientation
                true,                                    // include legend
                true,                                    // tooltips
          ...
          if (graphType.equalsIgnoreCase("Bar") && minorAxisFieldId.indexOf(",") == -1) {      // Bar Chart
            ...
            DefaultCategoryDataset collection = createBarGraphCategoryDataset(folderDataList);
          ...
          if (graphType.toLowerCase().contains("line") && graphType.toLowerCase().contains("bar")) {    //Combined Chart
            ...
            CategoryDataset dataset1 = createCombinedGraphCategoryDataset1(folderDataList);
            NumberAxis rangeAxis1 = new NumberAxis(minorAxisFieldName2);
            ...
            CategoryDataset dataset2 = createCombinedGraphCategoryDataset2(folderDataList);
            NumberAxis rangeAxis2 = new NumberAxis(minorAxisFieldName1);
  ...
  /**
   * Creates the dataset for rendering Line chart
   *
   * @param folderDataList Description of the Parameter
   * @return defaultCategoryDataset dataset
   */
  private DefaultCategoryDataset createLineGraphCategoryDataset(List folderDataList) {
  ...
  /**
   * Creates the dataset for rendering Combined Line chart
   *
   * @param folderDataList Description of the Parameter
   * @return defaultCategoryDataset dataset
   */
  private DefaultCategoryDataset createCombinedLineGraphCategoryDataset(List folderDataList) {
    DefaultCategoryDataset categoryDataset = new DefaultCategoryDataset();
    if (minorAxisFieldId.indexOf(",") > -1) {
      ...
      for (int count = 0; count < folderDataList.size(); count++) {
        ...
        while (strToken.hasMoreTokens()) {
          minorAxisList.add(index, strToken.nextToken());
          index++;
        }
        ...
        categoryDataset.addValue(Double.parseDouble(minorAxisList.get(0).toString()), minorAxisFieldName1, xValue);
        categoryDataset.addValue(Double.parseDouble(minorAxisList.get(1).toString()), minorAxisFieldName2, xValue);
        minorAxisList.clear();
      }
    }
    return categoryDataset;
   ...
   * @return defaultCategoryDataset dataset
   */
  private DefaultCategoryDataset createBarGraphCategoryDataset(List folderDataList) {
    DefaultCategoryDataset categoryDataset = new DefaultCategoryDataset();
    if (minorAxisFieldId.indexOf(",") == -1) {
      for (int count = 0; count < folderDataList.size(); count++) {
        String combinedValue = (String) folderDataList.get(count);
  ...
  /**
   * Creates the dataset for rendering chart
   *
   * @param folderDataList Description of the Parameter
   * @return defaultCategoryDataset dataset
   */
  private DefaultCategoryDataset createCombinedGraphCategoryDataset1(List folderDataList) {
    DefaultCategoryDataset categoryDataset = new DefaultCategoryDataset();
    ...
    for (int count = 0; count < folderDataList.size(); count++) {
      ...
      categoryDataset.addValue(Double.parseDouble(minorAxisList.get(0).toString()), minorAxisFieldName2, xValue);
      minorAxisList.clear();
      listIndex = 0;
    }
    return categoryDataset;
   ...
   * @return defaultCategoryDataset dataset
   */
  private DefaultCategoryDataset createCombinedGraphCategoryDataset2(List folderDataList) {
    DefaultCategoryDataset categoryDataset = new DefaultCategoryDataset();
    ...
    for (int count = 0; count < folderDataList.size(); count++) {
      ...
      categoryDataset.addValue(Double.parseDouble(minorAxisList.get(1).toString()), minorAxisFieldName1, xValue);
      minorAxisList.clear();
      listIndex = 0;
    }
    return categoryDataset;
   ...
   */
  private void getMinorAxisInfo(String param, GraphTypeList graphList) {

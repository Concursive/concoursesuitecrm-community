...
public class HelpFeatureList extends ArrayList {
  public final static String tableName = "help_features";
  public final static String uniqueField = "feature_id";
  ...
  /**
   * Sets the lastAnchor attribute of the HelpFeatureList object
   *
  ...
  /**
   * Sets the nextAnchor attribute of the HelpFeatureList object
   *
  ...
  /**
   * Sets the syncType attribute of the HelpFeatureList object
   *
  ...
  /**
   * Gets the tableName attribute of the HelpFeatureList object
   *
  ...
  /**
   * Gets the uniqueField attribute of the HelpFeatureList object
   *

...
public class StringUtils {
	...
	/**
	 * Returns precissionString if user pass inputString,precission and precisionMandatory
	 * @param String inputString
	 * @param int precision
	 * @param boolean precisionMandatory
	 * @return precissionString
	 */
	...
	/**
	 * Checks whether a given char is a digit or not	
	 * @return boolean true if given char is a digit else false
	 */

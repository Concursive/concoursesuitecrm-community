...
public class HtmlSelectTimeZone {
  ...
  public static void populateSelect(HtmlSelect select) {
    //select.addItem("Etc/GMT+12", "GMT-12 Kwajalein");
    ...
    //select.addItem("Etc/GMT+7", "GMT-7 Chihuahua, La Pa");
    ...
    select.addItem("US/Eastern", "GMT-5 Eastern US");
    ...
    select.addItem("Canada/Newfoundland", "GMT-3:30 Newfoundland");
    //select.addItem("", "GMT-3 Brasilia");
    select.addItem("America/Buenos_Aires", "GMT-3 Buenos Aires");
    //select.addItem("", "GMT-3 Greenland");
    //select.addItem("", "GMT-2 Mid-Atlantic");
    ...
    //select.addItem("", "GMT+1 West Central Africa");
    ...
    //select.addItem("", "GMT+12 New Zealand");

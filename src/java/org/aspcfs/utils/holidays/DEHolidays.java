...
public class DEHolidays {
  ...
  public final static void addTo(CalendarView calendarView, int theYear) {
    ...
    calendarView.addEvent("5/1/" + theYear, CalendarEventList.EVENT_TYPES[7], thisEvent);

    //October 3; Day of German Unity; Tag der Deutschen Einheit
    thisEvent = new CalendarEvent();
    thisEvent.setSubject("Tag der Deutschen Einheit");
    calendarView.addEvent("10/3/" + theYear, CalendarEventList.EVENT_TYPES[7], thisEvent);

    //October 31; Reformation Day; Reformationstag
    thisEvent = new CalendarEvent();
    thisEvent.setSubject("Reformationstag");
    calendarView.addEvent("10/31/" + theYear, CalendarEventList.EVENT_TYPES[7], thisEvent);

    //3rd Wednesday in November; Repentance Day; Bu§- und Bettag
    ...
    thisEvent = new CalendarEvent();
    thisEvent.setSubject("Bu§- und Bettag");
    calendarView.addEvent("11/" + (tmpCal.get(Calendar.DATE) + 14) + "/" + theYear, CalendarEventList.EVENT_TYPES[7], thisEvent);

...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'TroubleTickets.do?command=Details&id=' + thisTicketId+'&defectCheck=<%= defect.getId() %>';
  }
  
  function modify() {
    window.location.href = 'TroubleTickets.do?command=Modify&id=' + thisTicketId +'&defectCheck=<%= defect.getId() %>&return=defectDetails';
  }
</script>

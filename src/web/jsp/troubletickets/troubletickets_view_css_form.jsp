...
<table>
  <tr>
    <th align="center" colspan=2 width="100%" nowrap>
      <h2> Dataline, Incorporated &nbsp [status: <%= ticketDetails.getClosed() == null ? "Open" : "Closed" %>]</h2>
    </th>
  </tr>
</table>
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="details">
  ...
  <tr>
   ...
   <tr>
    <td align="center" colspan=2><h3> CSS Status Report </h3></td>
   </tr>
   <tr>
   ...
   <tr>
     <td colspan=2>
       <table cellpadding="4" cellspacing="0" border="0" width="100%" frame="border" rules="all">
         ...
         <tr>
           <td colspan=2> Travel hours </td>
           <td colspan=2>  </td>
           <td> Follow-up for these items required? </td>
         </tr>
        <tr>
           <td rowspan=2 colspan=2> Labor hours </td>

...
<table cellpadding="4" cellspacing="0" border="1" width="100%" bordercolorlight="#000000" bordercolor="#FFFFFF">
  ...
  <tr>
    ...
    <td colspan=4>
      ...
      <!--option value="my">Tickets Assigned to Me</option>
      <option value="open">Open/Unassigned Tickets</option-->
  ...
  <tr>
    ...
    <td colspan=4>
      ...
      <!--option value="t.org_id">Organization (assigned to)</option>
      <option value="t.contact_id">Contact (assigned to)</option>
      <option value="t.problem">Issue</option>

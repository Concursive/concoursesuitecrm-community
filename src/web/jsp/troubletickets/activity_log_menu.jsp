...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'TroubleTicketActivityLog.do?command=View&id=' + thisTicketId + '&formId=' + thisFromId;
  }
  
  
  function modify() {
    window.location.href = 'TroubleTicketActivityLog.do?command=Modify&id=' + thisTicketId + '&formId=' + thisFromId + '&return=list';
  }

  function deleteNote() {
    popURLReturn('TroubleTicketActivityLog.do?command=ConfirmDelete&id=' + thisTicketId + '&formId=' + thisFromId + '&popup=true','TroubleTicketActivityLog.do?command=List&id=' + thisTicketId,'Delete_maintenancenote','330','200','yes','no');
  }

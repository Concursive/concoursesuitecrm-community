...
<script type="text/javascript">
  ...
  function getContactId(form) {
    return form.contactId.options[form.contactId.options.selectedIndex].value;
  }
  ...
  function populateAddress(line1, line2, line3, city, state, otherState, zip, country, type) {
    var addressValue = "";
    if (line1 != "") {
      addressValue = line1;
    }
        ...
        <tr>
          ...
          <td>
            ...
            <dhv:evaluate if="<%= changeAccount %>">
              ...
              [<a href="javascript:popAccountsListSingle('orgId','changeaccount', 'showMyCompany=false&filters=all|my|disabled');">Select</a>]
            </dhv:evaluate>
          </td>
        </tr>
      </table>

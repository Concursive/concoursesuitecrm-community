...
<form method="post" name="form_notes" action="Quotes.do?command=SaveNotes&quoteId=<%= quote.getId() %>&version=<%= version %>&auto-populate=true" onSubmit="return checkComplete();">
<%-- Trails --%>

...
<body onLoad="javascript:document.addCondition.description.focus();">
<form method="post" name="addCondition" action="QuotesConditions.do?command=Save&quoteId=<%= quote.getId() %>" onSubmit="return checkForm(this);">
<dhv:formMessage showSpace="false" />
<input type="hidden" name="quoteId" value="<%= quote.getId() %>" />
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  <tr>
    <th colspan="2"><dhv:label name="quotes.newTermsAndConditions">New Terms and Conditions</dhv:label>
    </th>
  </tr>

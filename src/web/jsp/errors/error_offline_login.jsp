...
<table cellspacing="0"><tr>
  ...
  <td>
  	<p><dhv:label name="offline.error.systemInConflictingState.text">Centric CRM Offline has detected the system to be in a conflicting state. Some of the required system files could be missing or corrupt.</dhv:label></p>

...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="portalTabs" style="padding-bottom: 6px;">
  ...
  <tr>
    ...
    <td width="100%" class="portalTabBackground">&nbsp;</td>
  </tr>
</table>
<%-- Portlets --%>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="portalBody" style="padding-left:8px;padding-right:6px">
  <tr>

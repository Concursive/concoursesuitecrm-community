...
<script language="JavaScript">
  ...
  function doCheck() {
    if(document.forms['searchCategoryNumber'].categoryId.value == ""){
      ...
      if(!result){
        alert('Incorrect format! Please enter a number');
        return false;
      }
    }
    return true;
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  <tr>
    <th colspan="2">
      <strong>Search Categories By Number</strong>
    </th>
  </tr>
<form name="searchCategoryNumber" action="Products.do?command=Search" method="post" onSubmit="return doCheck();">
  ...
  <tr>
    <td colspan="2">
      <input type="submit" value="Search"/>&nbsp;<input type="reset" value="Reset" onClick="clearForm();"/>
    </td>
  </tr>
</form>
</table>

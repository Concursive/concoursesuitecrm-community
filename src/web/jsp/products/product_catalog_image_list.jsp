...
<dhv:container name="productcatalogs" selected="images" object="productCatalog" param="<%= param1 + "|" + param2 %>">
      <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
          ...
          <th style="text-align: center;"><dhv:label name="quotes.date">Date</dhv:label></th>
				...
				<tr class="containerBody">
					...
					<td width="10" valign="middle" style="text-align: center;" nowrap>
						<a href="ProductCatalogs.do?command=DownloadFile&catalogId=<%= ProductCatalog.getId() %>&fid=<%= ThumbnailImage.getId() %>"><dhv:label name="button.download">Download</dhv:label></a><br />
						<a href="javascript:confirmDelete('ProductCatalogs.do?command=RemoveFile&fid=<%= ThumbnailImage.getId() %>&catalogId=<%= ProductCatalog.getId()%>&moduleId=<%= PermissionCategory.getId() %>&imageType=thumbnail');"><dhv:label name="button.remove">Remove</dhv:label></a>
					</td>
          <td valign="middle" width="100%">
				...
				<tr class="containerBody">
					...
					<td width="10" valign="middle" style="text-align: center;" nowrap>
						<a href="ProductCatalogs.do?command=DownloadFile&catalogId=<%= ProductCatalog.getId() %>&fid=<%= SmallImage.getId() %>"><dhv:label name="button.download">Download</dhv:label></a><br />
						<a href="javascript:confirmDelete('ProductCatalogs.do?command=RemoveFile&fid=<%= SmallImage.getId() %>&catalogId=<%= ProductCatalog.getId()%>&moduleId=<%= PermissionCategory.getId() %>&imageType=small');"><dhv:label name="button.remove">Remove</dhv:label></a>
					</td>
          <td valign="middle" width="100%">
				...
				<tr class="containerBody">
					...
					<td width="10" valign="middle" style="text-align: center;" nowrap>
						<a href="ProductCatalogs.do?command=DownloadFile&catalogId=<%= ProductCatalog.getId() %>&fid=<%= LargeImage.getId() %>"><dhv:label name="button.download">Download</dhv:label></a><br />
						<a href="javascript:confirmDelete('ProductCatalogs.do?command=RemoveFile&fid=<%= LargeImage.getId() %>&catalogId=<%= ProductCatalog.getId()%>&moduleId=<%= PermissionCategory.getId() %>&imageType=large');"><dhv:label name="button.remove">Remove</dhv:label></a>
					</td>
          <td valign="middle" width="100%">
        ...
        <tr class="containerBody">
          <form method="post" name="inputForm" action="ProductCatalogs.do?command=UploadFile&id=<%= ProductCatalog.getId() %>&catalogId=<%= ProductCatalog.getId() %>&moduleId=<%= PermissionCategory.getId() %>" onSubmit="return checkForm(this);" enctype="multipart/form-data">
            <td width="100%">
              <center>

...
<table class="trails" cellspacing="0">
  <tr>
    <td>
      <a href="ProductsCatalog.do?command=CategoryList&hiddenFieldId=<%= request.getAttribute("hiddenFieldId") %>&displayFieldId=<%= request.getAttribute("displayFieldId") %>"><dhv:label name="product.productCatalog">Product Catalog</dhv:label></a> >
      <%
        trails.remove(0);
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  <tr>
    <th><dhv:label name="products.productName">Product Name</dhv:label></th>
    <th><dhv:label name="product.productDescription">Product Description</dhv:label></th>
  </tr>
  <%

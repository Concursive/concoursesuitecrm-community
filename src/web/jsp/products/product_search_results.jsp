...
<script type="text/javascript">
  function addToAction(value){
    document.forms['products'].action = document.forms['products'].action + value;
    document.forms['products'].submit();
  }
</script>
<form name="products" action="Products.do?command=Search" method="post">
<%-- Trails --%>
...
%>
      <a href="Products.do?command=Search"><dhv:label name="product.topCategories">Top Categories</dhv:label></a> >
<%
} else {
%>
...
%>
  <tr class="containerBody">
    <td nowrap valign="top"><a href="Products.do?command=Search&categoryId=<%= category.getId() %>"><%= category.getId() %></a></td>
    <td nowrap valign="top"><a href="Products.do?command=Search&categoryId=<%= category.getId() %>"><%= toHtml(category.getName()) %></a></td>
...
%>
  <tr class="containerBody">
    <td nowrap valign="top"><a href="javascript:addToAction('&categoryId=<%= category.getId() %>');"><%= category.getId() %></a></td>
    <td nowrap valign="top"><a href="javascript:addToAction('&categoryId=<%= category.getId() %>');"><%= toHtml(category.getName()) %></a></td>
    <td nowrap valign="top"><a href="javascript:addToAction('&categoryId=<%= category.getParentId() %>');"><%= toHtml(category.getParentName()) %></a></td>
    <td><%= toHtml(category.getShortDescription()) %></td>
  </tr>
<%

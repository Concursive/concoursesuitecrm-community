...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'NetworkApplicationsImports.do?command=Details&importId=' + thisImportId;
  }
  
  function deleteAction() {
   popURLReturn('NetworkApplicationsImports.do?command=ConfirmDelete&importId=' + thisImportId,'NetworkApplicationsImports.do?command=View', 'Delete_message','320','200','yes','no');
  }
  
  function cancel() {
   confirmDelete('NetworkApplicationsImports.do?command=Cancel&importId=' + thisImportId);
  }
  
  function process() {
   window.location.href = 'NetworkApplicationsImports.do?command=InitValidate&return=list&importId=' + thisImportId;
  }
</script>

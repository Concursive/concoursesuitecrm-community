...
<script language="javascript">
  ...
  function folderDetails() {
    window.location.href = 'LeadsFolders.do?command=Fields&headerId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '<%= addLinkParams(request, "popup|popupType|actionId") %>';
  }
  
  function modify() {
    window.location.href = 'LeadsFolders.do?command=ModifyFields&headerId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '&return=list<%= addLinkParams(request, "popup|popupType|actionId") %>';
  }
  
  function deleteField() {
    confirmDelete('LeadsFolders.do?command=DeleteFields&headerId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '&return=list<%= addLinkParams(request, "popup|popupType|actionId") %>');
  }

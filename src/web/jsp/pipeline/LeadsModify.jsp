...
<form name="modifyOpp" action="Leads.do?command=UpdateOpp&auto-populate=true<%= (request.getParameter("popup") != null?"&popup=true":"") %>" method="post">
<%boolean popUp = false;
...
<dhv:evaluate exp="<%= !popUp %>">
  ...
  <% if (request.getParameter("return") == null) { %>
    ...
    <a href="Leads.do?command=DetailsOpp&id=<%=HeaderDetails.getId()%>">Opportunity Details</a> >
    <%} else {%>
...
<input type="submit" value="Update" onClick="this.form.dosubmit.value='true';">
 ...
 <% if (request.getParameter("return") != null) {%>
	...
	<%}%>
    <%} else {%>
    	<input type="submit" value="Cancel" onClick="javascript:this.form.action='Leads.do?command=DetailsOpp&id=<%= HeaderDetails.getId() %>';this.form.dosubmit.value='false';">
<%}%>

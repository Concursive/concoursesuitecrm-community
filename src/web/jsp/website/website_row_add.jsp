...
<jsp:useBean id="pageRow" class="org.aspcfs.modules.website.base.PageRow" scope="request"/>
...
<form name="website" action="Tabs.do?command=Save&auto-populate=true&popup=true" onSubmit="return doCheck(this);" method="post">

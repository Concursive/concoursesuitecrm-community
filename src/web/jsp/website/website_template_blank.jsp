...
<%
      ...
      while (rowColumnIterator.hasNext()) {
        ...
        i++;
%>
        <td width="<%= (pageRow.getTotalColumnWidth() != 0? String.valueOf((double)(rowColumn.getWidth() * 100)/(double)pageRow.getTotalColumnWidth())+"%": String.valueOf(rowColumn.getWidth())) %>" valign="top">
          <dhv:evaluate if="<%= isPopup(request) %>">

<%-- 
  ...
  - 
  - Version: $Id: website_documents_list_menu.jsp  $
  - Description: 
  --%>
...
<script language="javascript">
  ...
  function displayMenu(loc, id, folderId, fileId) {
  ...
  //Folder operations
  function viewFolder() {
    window.location.href='WebsiteMedia.do?command=View&folderId=' + thisFolderId;
  }

  function editFolder() {
    window.location.href='WebsiteMediaFolders.do?command=Modify&folderId=' + thisFileId + '&id=' + thisFolderId + '&parentId='+thisFileId;
  }
  function moveFolder() {
    popURL('WebsiteMediaFolders.do?command=Move&id=' + thisFolderId + '&popup=true&return=WebsiteMedia&param='+ thisOrgId+'&param2='+ thisFolderId ,'Files','400','375','yes','yes');
  }
  function deleteFolder() {
    confirmDelete('WebsiteMediaFolders.do?command=Delete&id=' + thisFolderId + '&folderId=' + thisFileId );
  }

  //File operations
  function viewFileHistory() {
    document.location.href='WebsiteMedia.do?command=Details&fid=' + thisFileId + '&folderId='+thisFolderId;
  }
  function details() {
    window.location.href='WebsiteMedia.do?command=Details&fid=' + thisFileId+'&folderId='+ thisFolderId;
  }
  function modify() {
    window.location.href='WebsiteMedia.do?command=Modify&fid=' + thisFileId +'&folderId='+ thisFolderId;
  }
  function download() {
    window.location.href='WebsiteMedia.do?command=Download&fid=' + thisFileId+'&folderId='+ thisFolderId;
  }
  function view() {
    popURL('WebsiteMedia.do?command=Download&fid=' + thisFileId + '&view=true', 'Content', 640,480, 1, 1);
  }
  function addVersion() {
    document.location.href='WebsiteMedia.do?command=AddVersion&fid=' + thisFileId + '&folderId='+ thisFolderId;
  }
  function moveFile() {
    popURL('WebsiteMedia.do?command=Move&fid=' + thisFileId + '&popup=true&return=WebsiteMedia&param='+thisOrgId+'&param2='+thisFolderId,'Files','400','375','yes','yes');
  }
  function deleteFile() {
    confirmDelete('WebsiteMedia.do?command=Delete&fid=' + thisFileId + '&folderId='+ thisFolderId);
  }

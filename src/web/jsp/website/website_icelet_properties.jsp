        ...
        <tr>
            <td>
                ...
                <div id="toChange">
                    ...
                    <dhv:evaluate if='<%= iceletProperty == null || iceletProperty.getValueString() == null || "".equals(iceletProperty.getValueString()) %>'>
                        <dhv:label name="folder.range.select">12 Records Ago to Current</dhv:label>
                    </dhv:evaluate>
                </div>
            </td>
            <td>
                ...
                <input type="hidden" name="hiddenRangeSelect" id="hiddenRangeSelect" value="<%= "property_"+rowColumn.getId()+"_"+property.getTypeConstant() %>"/> &nbsp;

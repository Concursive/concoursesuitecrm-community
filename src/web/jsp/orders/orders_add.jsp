...
<table cellpadding="4" cellspacing="0" width="100%" class="details">
  ...
  <tr>
    ...
    <td><%= toHtmlValue("$" + (int) (product.getPriceAmount())) %></td>
  </tr>
</table>
<br />
<table cellpadding="4" cellspacing="0" width="100%" class="details">
...
<input type="button" value="cancel" value="Cancel" onClick="javascript:window.location.href='ProductsAndServices.do?command=Overview&pubId=<%= toHtmlValue(publication.getId()) %>'">

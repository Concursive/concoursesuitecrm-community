...
<table class="note" cellspacing="0">
  <tr>
    ...
    <td>
      <dhv:label name="calendar.webdavFolder.text">A web folder allows you to access documents and data in Concourse Suite Community Edition as if they were available on a network file share. Create a shared volume or folder to the following URL:</dhv:label><br />
      <br />

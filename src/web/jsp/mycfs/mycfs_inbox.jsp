...
<a href="javascript:popURL('/ForwardNote.do?command=ShowForm&popup=true&return=<%= java.net.URLEncoder.encode("MyCFSInbox.do?command%3DInbox") %>','Inbox_message','600','450','yes','no');">New Message</a>
<br>

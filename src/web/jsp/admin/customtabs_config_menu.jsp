...
<script language="javascript">
  ...
  function deleteColumn() {
    popURL('AdminCustomTabs.do?command=DeleteColumn&rowColumnId='+thisRowColumnId+'&pageVersionId='+thisPageVersionId+'&customtabId='+customtabId+'&moduleId='+moduleId+'&containerId='+containerId+'&popup=true','Delete_Tab','330','200','yes','no');
  }
</script>
...
<script language="javascript">
  ...
  function deleteThisRow() {
    popURL('AdminCustomTabs.do?command=DeleteRow&pageVersionId=' + thisPageVersionId +'&rowColumnId=' + thisRowColumnId +'&pageRowId=' + thisPageRowId+'&customtabId='+customtabId+'&moduleId='+moduleId+'&containerId='+containerId+'&popup=true', 'Delete_Row','330','200','yes','no');
  }
</script>

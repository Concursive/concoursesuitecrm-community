...
<table cellpadding="4" cellspacing="0" border="1" width="100%" class="pagedlist" bordercolorlight="#000000" bordercolor="#FFFFFF">
  <tr>
    ...
    <td valign="center" align="left" bgcolor="#DEE0FA" width="8" nowrap>
      <strong>Action</strong>
    </td>
    </dhv:permission>
    <td bgcolor="#DEE0FA" nowrap>
      <b><font class="column">
      <a href="Viewpoints.do?command=ListViewpoints&userId=<%= UserRecord.getId()%>&column=c.namelast">
      Viewpoint</a></font></b>
      <%= ViewpointListInfo.getSortIcon("c.namelast") %>
    </td>
    <td bgcolor="#DEE0FA" width="120">
      <b><font class="column">
      <a href="Viewpoints.do?command=ListViewpoints&userId=<%= UserRecord.getId()%>&column=vp.entered">
      Entered</a></font></b>
      <%= ViewpointListInfo.getSortIcon("vp.entered") %>
    </td>
    <td bgcolor="#DEE0FA" width="30">
      <b><font class="column">
      <a href="Viewpoints.do?command=ListViewpoints&userId=<%= UserRecord.getId()%>&column=vp.enabled">
      Enabled</a></font></b>

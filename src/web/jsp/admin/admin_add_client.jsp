<%-- 
  ...
  - 
  - Version: $Id: admin_add_client.jsp 13721 2005-12-29 20:43:02 -0500 (Thu, 29 Dec 2005) ananth $
  - Description:
  --%>
    ...
    <tr>
      <td>
        ...
        <a href="AdminClientManager.do?command=ShowClients"><dhv:label
          ...
          Manager</dhv:label></a> >
        <dhv:label name="admin.addClient">Add Client</dhv:label>
      </td>
    </tr>
  </table>
  <%-- End Trails --%>
  <%
    String title = "Add Sync Client";
    String titleLabel = "admin.addClient";
    java.util.Date entered = new java.util.Date();

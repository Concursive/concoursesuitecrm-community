...
<dhv:permission name="admin-sysconfig-view">
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
    ...
    <tr>
      ...
      <td>
        <input type="radio" name="ldapCentricCRMField" value="username" <%= ("username".equals(getPref(getServletConfig().getServletContext(), "LDAP.CENTRIC_CRM.FIELD")) ? "checked" : "") %> /><dhv:label name="admin.ldap.useCentricLogin">Use user's Concourse Suite Community Edition login</dhv:label><br />
        <input type="radio" name="ldapCentricCRMField" value="email" <%= ("email".equals(getPref(getServletConfig().getServletContext(), "LDAP.CENTRIC_CRM.FIELD")) ? "checked" : "") %> /><dhv:label name="admin.ldap.useUserEmail">Lookup user's primary email from Concourse Suite Community Edition records</dhv:label><br />
      </td>
    </tr>
    <tr>
      <td class="formLabel">

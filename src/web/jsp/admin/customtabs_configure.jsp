...
<%@ include file="customtabs_config_menu.jsp"%>
...
<script language="JavaScript" type="text/javascript">
		...
		var customtabId = <%= request.getParameter("customtabId") %>;
		var moduleId=<%=  request.getParameter("moduleId") %>;
		var containerId=<%=  request.getParameter("containerId") %>;
		  loadImages('select');
			function reopen() {
    		window.location.href='AdminCustomTabs.do?command=ConfigureCustomTab&customtabId='+customtabId+'&moduleId='+moduleId+'&containerId='+containerId+'&popup=true';
  		}		  
		</script>

...
function page_init() {
  var list = parent.document.forms['addUserGroup'].elements['selTotalList'];
...
%>
  if ( !(inArray(parent.document.forms['addUserGroup'].elements['selectedUserList'], <%= thisUser.getId() %>)) ) {

...
<table class="note" cellspacing="0">
  <tr>
    ...
    <td><b><dhv:label name="admin.defaultLocale.question">What should the default language/locale be for the system?</dhv:label></b><br />
</td></tr></table>
<dhv:permission name="admin-sysconfig-view">
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
    <tr>
      <th colspan="2">
        <strong><dhv:label name="admin.modifyDefaultLocale">Modify Default Language/Locale</dhv:label></strong>
      </th>
    </tr>
    <tr class="containerBody">
      <td class="formLabel">
        <dhv:label name="admin.languageLocale">Language/Locale</dhv:label>
      </td>
      <td>

...
<tr>
    ...
    <td><b><dhv:label name="admin.emailAddress.question">What email address should be in the FROM field of all emails sent by Concourse Suite Community Edition?</dhv:label></b>
</td></tr></table>

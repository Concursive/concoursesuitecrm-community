...
<%@ page import="java.util.Iterator,com.darkhorseventures.cfsbase.PermissionCategory, com.darkhorseventures.webutils.LookupList,com.darkhorseventures.webutils.LookupListElement" %>
<jsp:useBean id="LookupLists" class="com.darkhorseventures.webutils.LookupListList" scope="request"/>

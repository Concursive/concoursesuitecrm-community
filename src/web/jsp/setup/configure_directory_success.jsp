...
<table border="0" width="100%">
  ...
  <tr>
    <td>
      ...
      <br>
      <dhv:label name="setup.centricCRMstoresUserDataAt.colon">Centric CRM will now store system and user data at:</dhv:label><br>
      <b><%= toHtml(request.getParameter("fileLibrary")) %></b><br>
      <br>
      <dhv:label name="setup.timeToConfigureServerSettings.text">Now it's time to configure the Centric CRM server settings.</dhv:label><br>
      <br>

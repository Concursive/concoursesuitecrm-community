...
<form method="post" name="inputForm" action="SalesDocuments.do?command=UploadVersion<%= addLinkParams(request, "popup|popupType|actionId|actionplan|from|listForm") %>" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">

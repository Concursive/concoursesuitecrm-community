...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'SalesImports.do?command=ContactDetails&contactId=' + thisContactId;
  }
  
  function deleteContact() {
    url = 'SalesImports.do?command=DeleteContact&contactId=' + thisContactId + '&importId=<%= ImportDetails.getId() %>&return=list';
    confirmDelete(url);
  }

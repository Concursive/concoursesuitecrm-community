...
<jsp:useBean id="ContactRptListInfo" class="com.darkhorseventures.webutils.PagedListInfo" scope="session"/>
<%@ include file="initPage.jsp" %>
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" SRC="/javascript/confirmDelete.js"></SCRIPT>
<script language="JavaScript" type="text/javascript" src="/javascript/popURL.js"></script>
<form name="listView" method="post" action="/ExternalContacts.do?command=Reports">
<a href="/ExternalContacts.do?command=GenerateForm">Generate new report</a>
...
%>      
  <tr>
    ...
    <a href="/ExternalContacts.do?command=DownloadCSVReport&fid=<%= thisItem.getId() %>">D/L</a>|<a href="javascript:confirmDelete('/ExternalContacts.do?command=DeleteReport&pid=-1&fid=<%= thisItem.getId() %>');">Del</a>
    </td>
...
<br>
[<%= ContactRptListInfo.getPreviousPageLink("<font class='underline'>Previous</font>", "Previous") %> <%= ContactRptListInfo.getNextPageLink("<font class='underline'>Next</font>", "Next") %>] <%= ContactRptListInfo.getNumericalPageLinks() %>
<%} else {%>

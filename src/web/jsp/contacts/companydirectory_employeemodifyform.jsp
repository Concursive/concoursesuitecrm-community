...
%>
  ...
  var country = document.forms['modEmployee'].elements[countryObj].value;
...
<form name="modEmployee" action="CompanyDirectory.do?command=UpdateEmployee&auto-populate=true" onSubmit="return doCheck(this);" method="post">

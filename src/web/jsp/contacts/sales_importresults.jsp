...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="pagedList">
  <tr>
    ...
    <th nowrap>
      <strong><a href="SalesImports.do?command=ViewResults&importId=<%= ImportDetails.getId() %>&column=c.company"><dhv:label name="accounts.accounts_contacts_detailsimport.Company">Company</dhv:label></a></strong>
      <%= SalesImportResultsInfo.getSortIcon("c.company") %>
    </th>
    <th>

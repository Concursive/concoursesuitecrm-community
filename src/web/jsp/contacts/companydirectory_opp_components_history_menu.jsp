...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'ExternalContactsOppComponents.do?command=ComponentHistoryDetails&contactId=' + thisContactId + '&id=' + thisCompId + '&return=details<%= addLinkParams(request, "viewSource|popup") %>';
  }

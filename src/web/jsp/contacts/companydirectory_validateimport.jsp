...
<input type="submit" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="javascript:this.form.action='ExternalContactsImports.do?command=View';this.form.dosubmit.value='false';">
<br />
<dhv:formMessage />
    ...
    <table class="empty">
        <tr>
          ...
          <td>
            ...
            &nbsp;[<a href="javascript:popContactsListSingle('ownerid','changeowner', 'usersOnly=true&siteId=<%= User.getUserRecord().getSiteId() %>&mySiteOnly=true&reset=true');"><dhv:label name="accounts.accounts_contacts_validateimport.ChangeOwner">Change Owner</dhv:label></a>]
         </td>
        </tr>
    </table>
  </td>

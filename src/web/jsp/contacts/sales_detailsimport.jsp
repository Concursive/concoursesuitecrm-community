...
<script language="JavaScript">
  function confirmApprove() {
    if(confirmAction(label('are.you.sure','Are you sure?'))){
      window.location.href='SalesImports.do?command=Approve&importId=<%= ImportDetails.getId() %>';
    }
  }
</script>
<%-- Trails --%>
...
<input type="button" value="<dhv:label name="accounts.accounts_contacts_detailsimport.Process">Process</dhv:label>" onClick="javascript:window.location.href='SalesImports.do?command=InitValidate&importId=<%= ImportDetails.getId() %>'">
</dhv:permission>
<% } %>
...
<dhv:permission name="sales-import-view">
<input type="button" value="<dhv:label name="global.button.delete">Delete</dhv:label>" onClick="javascript:popURL('SalesImports.do?command=ConfirmDelete&importId=<%= ImportDetails.getId() %>','Delete_message','320','200','yes','no');">
</dhv:permission>
</dhv:evaluate>
<dhv:evaluate if="<%= ImportDetails.hasBeenProcessed() %>">
<dhv:permission name="sales-import-view">
<input type="button" value="<dhv:label name="global.button.ViewResults">View Results</dhv:label>" onClick="javascript:window.location.href='SalesImports.do?command=ViewResults&importId=<%= ImportDetails.getId() %>';">
</dhv:permission>
</dhv:evaluate>

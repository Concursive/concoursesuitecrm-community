...
<tr>
  <td>
    ...
    <a href="SalesImports.do?command=View"><dhv:label name="contacts.companydirectory_confirm_importupload.Import">Import</dhv:label></a> >
    <a href="SalesImports.do?command=New"><dhv:label name="contacts.companydirectory_confirm_importupload.NewImport">New Import</dhv:label></a> >
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
  ...
  <td>
    <%= ImportDetails.getFile().getClientFilename() %>&nbsp;&nbsp;[ <a href="javascript:window.location.href='SalesImports.do?command=Download&importId=<%= ImportDetails.getId() %>&fid=<%= ImportDetails.getFile().getId() %>'"><dhv:label name="accounts.accounts_contacts_detailsimport.DownloadFile">Download File</dhv:label></a> ]
  </td>
  </tr>
  <tr class="containerBody">
  <td class="formLabel" nowrap>
...
<input type="button" value="<dhv:label name="global.button.ProcessNow">Process Now</dhv:label>" onClick="javascript:window.location.href='SalesImports.do?command=InitValidate&importId=<%= ImportDetails.getId() %>';">&nbsp;
<input type="button" value="<dhv:label name="global.button.ProcessLater">Process Later</dhv:label>" onClick="javascript:window.location.href='SalesImports.do';">

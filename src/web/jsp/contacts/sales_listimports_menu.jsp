...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'SalesImports.do?command=Details&importId=' + thisImportId;
  }
  
  function deleteAction() {
   popURLReturn('SalesImports.do?command=ConfirmDelete&importId=' + thisImportId,'SalesImports.do?command=View', 'Delete_message','320','200','yes','no');
  }
  
  function cancel() {
   confirmDelete('SalesImports.do?command=Cancel&importId=' + thisImportId);
  }
  
  function process() {
   window.location.href = 'SalesImports.do?command=InitValidate&return=list&importId=' + thisImportId;
  }
</script>

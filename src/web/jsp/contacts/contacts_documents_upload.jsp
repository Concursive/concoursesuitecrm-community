...
<form method="post" name="inputForm" action="ExternalContactsDocuments.do?command=Upload<%= addLinkParams(request, "popup|popupType|actionId|actionplan") %>" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">

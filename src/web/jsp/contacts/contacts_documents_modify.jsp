...
<form method="post" name="inputForm" action="ExternalContactsDocuments.do?command=Update<%= addLinkParams(request, "popup|popupType|actionId") %>" onSubmit="return checkFileForm(this);">
...
<table border="0" cellpadding="4" cellspacing="0" width="100%">
  <tr class="subtab">
    <td>
      <% String documentLink = "ExternalContactsDocuments.do?command=View&contactId="+ContactDetails.getId(); %>
  ...
  <input type="submit" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="javascript:this.form.dosubmit.value='false';this.form.action='ExternalContactsDocuments.do?command=View<%= addLinkParams(request, "popup|popupType|actionId|actionplan") %>';" />
</dhv:container>
</form>
</body>

<%-- 
  ...
  - 
  - Version: $Id: sales_fields_list_menu.jsp 
  - Description:
  --%>
...
<script language="javascript">
  ...
  function folderDetails() {
    window.location.href = 'SalesFolders.do?command=Fields&contactId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '<%= addLinkParams(request, "popup|popupType|actionId") %>';
  }
  
  function modify() {
    window.location.href = 'SalesFolders.do?command=ModifyFields&contactId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '&return=list<%= addLinkParams(request, "popup|popupType|actionId") %>';
  }
  
  function deleteField() {
    confirmDelete('SalesFolders.do?command=DeleteFields&contactId=' + thisContactId + '&catId=' + thisCatId + '&recId=' + thisRecId + '&return=list<%= addLinkParams(request, "popup|popupType|actionId") %>');
  }

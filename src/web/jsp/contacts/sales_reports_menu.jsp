<%-- 
  ...
  - 
  - Version: $Id: sales_reports_menu.jsp 
  - Description: 
  --%>
...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    popURL('Sales.do?command=ShowReportHtml&pid=-1&fid=' + thisReportId + '&popup=true&popup=true','Report','600','400','yes','yes');
  }
  
  function download() {
    window.location.href = 'Sales.do?command=DownloadCSVReport&fid=' + thisReportId;
  }
  
  function deleteReport() {
    confirmDelete('Sales.do?command=DeleteReport&pid=-1&fid=' + thisReportId);
  }
...
<div id="menuReportContainer" class="menu">
  <div id="menuReportContent">
    <table id="menuReportTable" class="pulldown" width="170" cellspacing="0">
      <dhv:permission name="sales-reports-view">
      ...
      <dhv:permission name="sales-reports-delete">

...
<form name="details" action="SalesFolders.do?command=Fields&contactId=<%= ContactDetails.getId() %>&catId=<%= Category.getId() %>" method="post">
<dhv:evaluate if="<%= !isPopup(request) %>">
<%-- Trails --%>
<table class="trails" cellspacing="0">
<tr>
<td>
<a href="Sales.do"><dhv:label name="Contact1s" mainMenuItem="true">Leads</dhv:label></a> >
<a href="Sales.do?command=Details&id=<%=ContactDetails.getId()%>"><dhv:label name="accounts.accounts_contacts_ad1d.ContactDetails">Leads Details</dhv:label></a> >

...
<script language="javascript">
  ...
  function displayMenu(loc, id, historyId, contactId, objectId, itemId, canView, canModify, canDelete ) {
    ...
    if (thisObjectId == '<%= OrganizationHistory.NOTE %>') {
      ...
      urlDetails = 'ExternalContactsCalls.do?command=Details&contactId='+thisContactId+'&id='+ thisItemId+'<%= isPopup(request)?"&popup=true":"" %>';
      urlModify = 'ExternalContactsCalls.do?command=Modify&contactId='+thisContactId+'&id='+ thisItemId+'<%= isPopup(request)?"&popup=true":"" %>';
      isPopup = false;
      ...
      hideSpan('menuEditContactHistoryObject');
      urlDetails = 'ExternalContacts.do?command=MessageDetails&id='+ thisItemId +'&contactId='+ thisContactId+'<%= isPopup(request)?"&popup=true":"" %>';
      isPopup = false;
      ...
      urlDetails = 'TroubleTickets.do?command=Details&id='+ thisItemId +'<%= isPopup(request)?"&popup=true":"" %>';
      ...
      if (thisCanModify) {
       ...
       urlDetails = 'MyTasks.do?command=Details&id='+ thisItemId +'<%= isPopup(request)?"&popup=true":"" %>';
       urlModify = 'MyTasks.do?command=Modify&id='+ thisItemId +'<%= isPopup(request)?"&popup=true":"" %>';
      isPopup = false;
      ...
      urlDetails = 'ExternalContactsOppComponents.do?command=DetailsComponent&id='+thisItemId+'&contactId='+thisContactId+'<%= isPopup(request)?"&popup=true":"" %>';

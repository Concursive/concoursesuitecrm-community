<%-- 
  ...
  - Version: $Id: projects_center_accounts_menu.jsp 12404 2005-08-05 17:37:07 +0000 (Fri, 05 Aug 2005) mrajkowski $
  - Description: 
  --%>
...
<script language="javascript">
 ...
 function updateMenu(trashed){
  ...
  function removeAccount() {
    confirmDelete('DocumentStoreManagementAccounts.do?command=RemoveAccount&documentStoreId=<%= documentStore.getId() %>&orgId=' + thisOrgId);
  }
</script>
...
<div id="menuItemContainer" class="menu">
  <div id="menuItemContent">
    ...
    <dhv:documentPermission name="accounts-accounts-documentstore-delete">      

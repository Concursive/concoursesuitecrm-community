...
<table cellpadding="0" cellspacing="0" width="100%" border="1" rules="cols">
  <tr class="section">
    <td valign="top" width="100%">
      ...
      <a href="ProjectManagementFiles.do?command=SaveMove&pid=<%= Project.getId() %>&fid=<%= FileItem.getId() %>&popup=true&folderId=0&return=ProjectFiles&param=<%= Project.getId() %>&param2=<%= FileItem.getFolderId() %>"><dhv:label name="accounts.accounts_documents_file_move.Home">Home</dhv:label></a>

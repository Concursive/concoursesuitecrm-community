...
<form method="POST" name="inputForm" action="ProjectManagementRequirements.do?command=Update&auto-populate=true" onSubmit="return checkForm(this);">
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
      <td width="2" bgcolor="#000000">&nbsp;</td>
      <td width="100%" colspan="2" bgcolor="#000000" rowspan="2">
        <font color="#FFFFFF"><b>&nbsp;Update Requirements</b></font>
      </td>
      <td width="2" bgcolor="#000000">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="100%" colspan="2">&nbsp;<br>
        ...
        &nbsp;
        <input type="text" name="shortDescription" size="57" maxlength="255" value="<%= toHtmlValue(Requirement.getShortDescription()) %>"><font color=red>*</font><br>
        &nbsp;
      </td>
      <td width="2" bgcolor="#000000">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td width="50%">&nbsp;Requirements Due:<br>
        &nbsp;
    ...
    <tr>
      ...
      <td width="100%" colspan="2">&nbsp;Requirements:<br>
        &nbsp;
        <textarea rows="8" name="description" cols="80"><%= toString(Requirement.getDescription()) %></textarea><font color=red>*</font><br>
        &nbsp;
      </td>
      <td width="2" bgcolor="#000000">&nbsp;</td>
    </tr>

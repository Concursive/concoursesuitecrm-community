<%--
  ...
  -
   - Version: $Id: fields.jsp 4.1 2007-05-04 18:32:57 +0530 (Fri, 04 May 2007) nagarajay $
  - Description:
  --%>
...
<form name="details" action="" method="post">
  ...
  <dhv:evaluate if="<%=Category.getCanEdit()%>">
    <input type="submit" value="<dhv:label name="global.button.modify">Modify</dhv:label>"
           onClick="javascript:this.form.action='<portlet:renderURL><portlet:param name="viewType" value="edit"/><portlet:param name="recordId" value="<%=Integer.toString(Record.getId())%>"/></portlet:renderURL>'">
  </dhv:evaluate>
  ...
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
    <tr>
      <th colspan="2">
        <strong><dhv:label name="accounts.accounts_contacts_calls_details.RecordInformation">Record

    ...
    <td>
      <table border="0" cellpadding="0" cellspacing="0" class="empty">
        <tr>
          ...
          <td valign="top">
            [<a href="javascript:popContactsListMultiple('listViewId','1', 'reset=true<%= User.getUserRecord().getSiteId() == -1?"&includeAllSites=true&siteId=-1":"&mySiteOnly=true&siteId="+ User.getUserRecord().getSiteId() %>');"><dhv:label name="calendar.addRecipients">Add Recipients</dhv:label></a>]<font color="red">*</font>

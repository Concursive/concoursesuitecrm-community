      ...
      <table cellpadding="4" cellspacing="0" border="1" width="100%" bordercolorlight="#000000" bordercolor="#FFFFFF">
        <tr class="containerHeader">
          <td colspan="7" width="100%" valign="center">
            ...
            <input type="hidden" name="quest<%=k%>id" value="<%= ((ActiveSurveyQuestion)ActiveSurvey.getQuestions().get(k-1)).getId() %>">
          </td>
        </tr>
<% 
            if (ActiveSurvey.getType() != 1) { 
%>
        ...
        <tr class="containerBody">
          ...
          <td colspan="6" valign="center">
            <textarea name="quest<%=k%>comments" rows=2 cols=80></textarea>
                ...
                <%} else if (ActiveSurvey.getType() == 1) {%>
        <tr class="containerBody">
          <td width=15% valign=center align=right>
            Response
          </td>

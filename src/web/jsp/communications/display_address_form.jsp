...
<tr>
  ...
  <td>
    <dhv:label name="accounts.accounts_add.addressRequestMessage">Address Update Form. You have recieved this request to update your contact information from Centric CRM.</dhv:label>
  </td>
</tr>
</table>
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">

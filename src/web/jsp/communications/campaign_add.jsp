...
<script language="JavaScript">
  function checkForm(form) {
    ...
    if (checkNullString(form.name.value)) { 
      message += label("check.campaign.name","- Campaign name is requred\r\n");
      formTest = false;
    }
    if (formTest == false) {
...
<dhv:label name="campaign.addCampaign">Add a Campaign</dhv:label>
</td>
</tr>
</table>
<%-- End Trails --%>
  <input type="submit" value="<dhv:label name="button.insert">Insert</dhv:label>" name="Save">
  <input type="submit" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="javascript:this.form.dosubmit.value='false';this.form.action='CampaignManager.do?command=View';">
  <br>
<dhv:formMessage />
  <table cellpadding="4" cellspacing="0" width="100%" class="details">
    <tr>
      <th colspan="2">
        <strong><dhv:label name="campaign.beginNaming.text">Begin by naming the campaign</dhv:label></strong>
      </th>
    </tr>
    <tr>
      <td class="formLabel">

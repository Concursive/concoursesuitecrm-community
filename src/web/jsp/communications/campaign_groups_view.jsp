...
<%-- End Trails --%>
<dhv:permission name="campaign-campaigns-groups-add"><a href="CampaignManagerGroup.do?command=Add&source=contacts"><dhv:label name="communications.campaign.addContactGroup">Add a Contact Group</dhv:label></a></dhv:permission>

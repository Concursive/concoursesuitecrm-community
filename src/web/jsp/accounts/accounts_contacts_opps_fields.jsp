...
<%@ page import="java.util.*,java.text.DateFormat,org.aspcfs.modules.contacts.base.*,org.aspcfs.modules.base.*,org.aspcfs.modules.pipeline.base.OpportunityComponent" %>
...
<dhv:evaluate if="<%= (Category.getAllowMultipleRecords() && Record != null) %>">
<a href="AccountContactsOpps.do?command=Fields&headerId=<%=OpportunityHeader.getId()%>&contactId=<%=ContactDetails.getId()%>&catId=<%= Category.getId() %>">List of Folder Records</a> >
...
<dhv:permission name="accounts-accounts-contacts-opps-folders-edit"><input type="button" value="Modify" onClick="javascript:this.form.action='AccountContactsOpps.do?command=ModifyFields&headerId=<%= OpportunityHeader.getId() %>&catId=<%= (String)request.getAttribute("catId") %>&recId=<%= Category.getRecordId() %>';submit();"></dhv:permission>
<dhv:permission name="accounts-accounts-contacts-opps-folders-delete"><input type="button" value="Delete Folder Record" onClick="javascript:this.form.action='AccountContactsOpps.do?command=DeleteFields&headerId=<%= OpportunityHeader.getId() %>&catId=<%= (String)request.getAttribute("catId") %>&recId=<%= Category.getRecordId() %>';confirmSubmit(this.form);"></dhv:permission>
<dhv:permission name="accounts-accounts-contacts-opps-folders-edit,accounts-accounts-contacts-opps-folders-delete">
<br>&nbsp;<br>
</dhv:permission>
</dhv:evaluate>
<%

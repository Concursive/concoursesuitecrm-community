...
<table cellpadding="0" cellspacing="0" width="100%" border="1" rules="cols">
  <tr class="section">
    <td valign="top" width="100%">
      ...
      <a href="AccountTicketsDocuments.do?command=SaveMove&tId=<%= TicketDetails.getId() %>&fid=<%= FileItem.getId() %>&popup=true&folderId=0&return=AccountTicketsDocuments&param=<%= TicketDetails.getId() %>&param2=<%= FileItem.getFolderId() %>">Home</a>

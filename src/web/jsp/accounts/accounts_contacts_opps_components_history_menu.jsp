...
<script language="javascript">
  ...
  //Menu link functions
  function details() {
    window.location.href = 'AccountContactsOppComponents.do?command=ComponentHistoryDetails&contactId=' + thisContactId + '&id=' + thisCompId + '&return=details<%= addLinkParams(request, "viewSource") %>';
  }

  ...
  <table class="trails" cellspacing="0">
    <tr>
      <td>
        ...
        <a href="AccountTickets.do?command=TicketDetails&id=<%=ticket.getId()%>"><dhv:label
            name="accounts.tickets.details">Ticket Details</dhv:label></a> >
        <%}%>
        <a href="AccountTicketActionPlans.do?command=List&ticketId=<%= ticket.getId() %>"><dhv:label
...
<dhv:container name="accounts" selected="tickets" object="OrgDetails"
  ...
  <dhv:container name="accountstickets" selected="actionplans" object="ticket"

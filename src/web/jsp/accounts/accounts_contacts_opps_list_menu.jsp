...
<script language="javascript">
  ...
  function displayMenu(loc, id, headerId, contactId, trashed, hasPermission) {
  ...
  function updateMenu(trashed){
    if (trashed == 'true'){
      hideSpan("menuOppRename");
      hideSpan("menuOppDelete");
    } else {
      showSpan("menuOppRename");
      showSpan("menuOppDelete");
    }
  }
  //Menu link functions
  function details() {
...
<div id="menuOppContainer" class="menu">
  <div id="menuOppContent">
    <table id="menuOppTable" class="pulldown" width="170" cellspacing="0">
      ...
      <tr id="menuOppRename" onmouseover="cmOver(this)" onmouseout="cmOut(this)" onclick="modify()">
        <th>
      ...
      <tr id="menuOppDelete" onmouseover="cmOver(this)" onmouseout="cmOut(this)" onclick="deleteOpp()">
        <th>

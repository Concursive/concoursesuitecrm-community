...
<script language="javascript">
  ...
  function reassign() {
    var URL = 'ContactsList.do?command=ContactList&listView=employees&usersOnly=true&siteId='+thisSiteId+'&listType=single&searchcodePermission=sales-leads-edit,tickets-action-plans-view,accounts-action-plans-view,myhomepage-action-plans-view&flushtemplist=true&hiddensource=reassignplan&actionplan=true&actionPlanWork=' + thisWorkId;
  ...
  function reviewNotes() {
    var URL = 'AccountTicketActionPlans.do?command=ViewNotes&ticketId=<%= ticket.getId() %>&planWorkId=' + thisWorkId;
    popURL(URL, 'Action_Plan', 700, 425, 'yes', 'yes');
  }

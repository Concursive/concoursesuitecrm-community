...
<dhv:container name="accounts" selected="contacts" object="OrgDetails" param="<%= "orgId=" + OrgDetails.getOrgId() %>">
  ...
  <table cellpadding="4" cellspacing="0" border="0" width="100%" class="details">
    ...
    <tr class="row<%= rowid %>">
      <td>
        <a href="Contacts.do?command=Fields&contactId=<%= ContactDetails.getId() %>&catId=<%= thisCategory.getId() %><%= addLinkParams(request, "popup|popupType|actionId") %>"><%= toHtml(thisCategory.getName()) %></a>
      </td>
      <td>

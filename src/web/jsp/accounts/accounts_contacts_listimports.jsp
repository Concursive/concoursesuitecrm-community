...
<dhv:permission name="accounts-accounts-contacts-imports-add">
  <a href="AccountContactsImports.do?command=New"><dhv:label name="contacts.companydirectory_confirm_importupload.NewImport">New Import</dhv:label></a><br>
</dhv:permission><br>
  ...
  <tr>
    ...
    <td align="left">
      <select size="1" name="listView" onChange="javascript:document.listView.submit();">
        <option <%= AccountContactsImportListInfo.getOptionValue("all") %>><dhv:label name="accounts.accounts_contacts_listimports.AllImports">All Imports</dhv:label></option>
        <option <%= AccountContactsImportListInfo.getOptionValue("my") %>><dhv:label name="accounts.accounts_contacts_listimports.MyImports">My Imports</dhv:label></option>
      </select>
    </td>
    <td>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="pagedList">
  <tr>
    ...
    <th rowspan="2" valign="middle" width="100%">
      <strong><a href="AccountContactsImports.do?command=View&column=m.name"><dhv:label name="contacts.name">Name</dhv:label></a></strong>
    ...
    <th rowspan="2" valign="middle" nowrap>
      <strong><a href="AccountContactsImports.do?command=View&column=m.entered"><dhv:label name="accounts.accounts_calls_list.Entered">Entered</dhv:label></a></strong>

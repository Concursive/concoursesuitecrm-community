...
<dhv:evaluate exp="<%= !Category.isEmpty() %>">
  &nbsp;<br>
  <input type="submit" value="Update" onClick="javascript:this.form.action='Contacts.do?command=UpdateFields&contactId=<%= ContactDetails.getId() %>&catId=<%= Category.getId() %>&recId=<%= Category.getRecordId() %>'">
  <input type="submit" value="Cancel" onClick="javascript:this.form.action='Contacts.do?command=Fields&contactId=<%= ContactDetails.getId() %>&catId=<%= Category.getId() %>'"><br>
&nbsp;<br>
</dhv:evaluate>
<%
...
<%}%>
  <dhv:evaluate exp="<%= !Category.isEmpty() %>">
    <br>
    <input type="submit" value="Update" onClick="javascript:this.form.action='Contacts.do?command=UpdateFields&contactId=<%= ContactDetails.getId() %>&catId=<%= Category.getId() %>&recId=<%= Category.getRecordId() %>'">
    <input type="submit" value="Cancel" onClick="javascript:this.form.action='Contacts.do?command=Fields&contactId=<%= ContactDetails.getId() %>&catId=<%= Category.getId() %>'">
  </dhv:evaluate>

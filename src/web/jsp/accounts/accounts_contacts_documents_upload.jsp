<%-- 
  ...
  - 
  - Version: $Id: accounts_contacts_documents_upload.jsp 28.12.2006 16:56:42 zhenya.zhidok $
  - Description:
  --%>
...
<form method="post" name="inputForm" action="AccountsContactsDocuments.do?command=Upload<%= addLinkParams(request, "popup|popupType|actionId|actionplan") %>" enctype="multipart/form-data" onSubmit="return checkFileForm(this);">

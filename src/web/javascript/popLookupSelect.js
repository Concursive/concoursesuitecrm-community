...
function popFieldsList(folderId,fieldListPropertyName,fieldNamesIds) {
  ...
  if (folderId == "-1") {
    ...
    var posy = (screen.height - height) / 2;
    var windowParams = 'WIDTH=' + width + ',HEIGHT=' + height + ',RESIZABLE=' + resize + ',SCROLLBARS=' + bars + ',STATUS=0,LEFT=' + posx + ',TOP=' + posy + 'screenX=' + posx + ',screenY=' + posy;
    var newwin = window.open('RowColumns.do?command=FieldsLists&folderId=' + folderId + '&fieldListPropertyName=' + fieldListPropertyName + '&fieldNamesIds='+fieldNamesIds+'', title, windowParams);
    newwin.focus();
    if (newwin != null) {
      if (newwin.opener == null)
        newwin.opener = self;
...
function popConfigureSpreadSheet(folderId, configurePropertyName, rows, cols, previousRows, previousColumns, configString) {
  title = 'FieldsInFolders';
  width = '500';
  height = '500';
  resize = 'yes';
  ...
  if (folderId != "-1" && document.getElementById("hiddenText") != null) {
  ...
  if (rows != null || cols != null) {
    if (rows <= 0 || rows == "" || cols <= 0 || cols == "") {
      alert("Please enter valid cell values");
      return;
    }
  }
 ...
 if(document.getElementById("hiddenConfigureSheet")!=null){
  ...
  var posy = (screen.height - height) / 2;
  var hiddenTextValue = document.getElementById("hiddenText").value;
  var hiddenSheetPreview = document.getElementById("hiddenSheetPreview").name;
  var windowParams = 'WIDTH=' + width + ',HEIGHT=' + height + ',RESIZABLE=' + resize + ',SCROLLBARS=' + bars + ',STATUS=0,LEFT=' + posx + ',TOP=' + posy + 'screenX=' + posx + ',screenY=' + posy;
  var newwin = window.open('RowColumns.do?command=SpreadSheetFieldsLists&folderId=' + folderId + '&configurePropertyName=' + configurePropertyName + '&previewPropertyName=' + hiddenSheetPreview + '&rows=' + rows + '&cols=' + cols + '&recordRange=' + document.getElementById(hiddenTextValue).value + '&configString=' + configString + '&finalString='+finalString+'&previousRows='+previousRows+'&previousColumns='+previousColumns+'', title, windowParams);
  newwin.focus();
  if (newwin != null) {
    if (newwin.opener == null)
      newwin.opener = self;

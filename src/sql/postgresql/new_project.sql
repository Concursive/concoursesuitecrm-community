...
CREATE TABLE users (
  ...
  start_page INTEGER DEFAULT 1 NOT NULL ,
	...
	last_login TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NULL,
  expiration TIMESTAMP(3) DEFAULT NULL
);
...
CREATE TABLE project_inbox (
	...
	user_id INTEGER NOT NULL ,
	read TIMESTAMP(3) NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE project_timesheet (
	...
	user_id INTEGER NOT NULL ,
	project_id INTEGER NOT NULL ,
	start_time TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL ,

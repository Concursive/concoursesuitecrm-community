...
CREATE TABLE lookup_asset_manufacturer (
    code integer DEFAULT nextval('lookup_asset_manufactu_code_seq'::text) NOT NULL,
    description character varying(300),
    default_item boolean DEFAULT false,
    "level" integer,
    enabled boolean DEFAULT true
...
CREATE TABLE lookup_ticket_escalation (
    code integer DEFAULT nextval('lookup_ticket_escalati_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE ticket (
    ...
    resolvable boolean DEFAULT true NOT NULL,
    resolvedby integer,
...
CREATE TABLE lookup_ticket_cause (
    code integer DEFAULT nextval('lookup_ticket_cause_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE lookup_ticket_resolution (
    code integer DEFAULT nextval('lookup_ticket_resoluti_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE ticket_defect (
    ...
    description text,
    start_date timestamp(3) without time zone DEFAULT ('now'::text)::timestamp(6) with time zone NOT NULL,
    end_date timestamp(3) without time zone,
    enabled boolean DEFAULT true NOT NULL,
    trashed_date timestamp(3) without time zone,
    site_id integer
...
CREATE TABLE lookup_ticket_state (
    code integer DEFAULT nextval('lookup_ticket_state_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE lookup_ticket_task_category (
    code integer DEFAULT nextval('lookup_ticket_task_cat_code_seq'::text) NOT NULL,
    description character varying(255) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE task (
    ...
    trashed_date timestamp(3) without time zone,
    ticket_task_category_id integer
);
...
CREATE TABLE action_plan_editor_lookup (
    id integer DEFAULT nextval('action_plan_editor_loo_id_seq'::text) NOT NULL,
    module_id integer NOT NULL,
    constant_id integer NOT NULL,
    "level" integer DEFAULT 0,
    description text,
...
CREATE TABLE lookup_duration_type (
    code integer DEFAULT nextval('lookup_duration_type_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true
...
CREATE TABLE lookup_step_actions (
    code integer DEFAULT nextval('lookup_step_actions_code_seq'::text) NOT NULL,
    description character varying(300) NOT NULL,
    default_item boolean DEFAULT false,
    "level" integer DEFAULT 0,
    enabled boolean DEFAULT true,
...
CREATE TABLE step_action_map (
    map_id serial NOT NULL,
    constant_id integer NOT NULL,
    action_constant_id integer NOT NULL
);



CREATE TABLE action_plan_work (
    plan_work_id serial NOT NULL,
...
CREATE TABLE action_plan_work_notes (
    note_id serial NOT NULL,
    plan_work_id integer NOT NULL,
    description character varying(4096) NOT NULL,
    submitted timestamp(3) without time zone DEFAULT ('now'::text)::timestamp(6) with time zone NOT NULL,
...
CREATE TABLE action_phase_work (
    phase_work_id serial NOT NULL,
    plan_work_id integer NOT NULL,
    action_phase_id integer NOT NULL,
    status_id integer,
    start_date timestamp(3) without time zone,
    end_date timestamp(3) without time zone,
    "level" integer DEFAULT 0,
...
CREATE TABLE action_item_work (
    item_work_id serial NOT NULL,
    phase_work_id integer NOT NULL,
...
CREATE INDEX contact_lead_skip_u_idx ON contact_lead_skipped_map USING btree (user_id);



CREATE INDEX contact_lead_read_u_idx ON contact_lead_read_map USING btree (user_id);



CREATE INDEX contact_lead_read_c_idx ON contact_lead_read_map USING btree (contact_id);



CREATE INDEX organization_address_postalcode_idx ON organization_address USING btree (postalcode);
...
CREATE INDEX contact_email_prim_idx ON contact_emailaddress USING btree (primary_email);
...
CREATE INDEX opp_contactlink_idx ON opportunity_header USING btree (contactlink);



CREATE INDEX opp_header_contact_org_id_idx ON opportunity_header USING btree (contact_org_id);



CREATE INDEX oppheader_description_idx ON opportunity_header USING btree (description);



CREATE INDEX oppcomplist_header_idx ON opportunity_component USING btree (opp_id);
...
CREATE INDEX ticketlink_project_idx ON ticketlink_project USING btree (ticket_id);
...
CREATE INDEX action_plan_constant_id ON action_plan_constants USING btree (constant_id);
...
ALTER TABLE ONLY lookup_account_size
    ADD CONSTRAINT lookup_account_size_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_segments
    ADD CONSTRAINT lookup_segments_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_sub_segment
    ADD CONSTRAINT lookup_sub_segment_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_title
    ADD CONSTRAINT lookup_title_pkey PRIMARY KEY (code);
...
ALTER TABLE ONLY user_group_map
    ADD CONSTRAINT user_group_map_pkey PRIMARY KEY (group_map_id);



ALTER TABLE ONLY custom_list_view_editor
    ADD CONSTRAINT custom_list_view_editor_pkey PRIMARY KEY (editor_id);



ALTER TABLE ONLY custom_list_view
    ADD CONSTRAINT custom_list_view_pkey PRIMARY KEY (view_id);



ALTER TABLE ONLY custom_list_view_field
    ADD CONSTRAINT custom_list_view_field_pkey PRIMARY KEY (field_id);
...
ALTER TABLE ONLY lookup_asset_manufacturer
    ADD CONSTRAINT lookup_asset_manufacturer_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_asset_vendor
    ADD CONSTRAINT lookup_asset_vendor_pkey PRIMARY KEY (code);
...
ALTER TABLE ONLY lookup_asset_materials
    ADD CONSTRAINT lookup_asset_materials_pkey PRIMARY KEY (code);



ALTER TABLE ONLY asset_materials_map
    ADD CONSTRAINT asset_materials_map_pkey PRIMARY KEY (map_id);
...
ALTER TABLE ONLY lookup_ticket_escalation
    ADD CONSTRAINT lookup_ticket_escalation_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_ticket_escalation
    ADD CONSTRAINT lookup_ticket_escalation_description_key UNIQUE (description);
...
ALTER TABLE ONLY ticket_category_draft_assignment
    ADD CONSTRAINT ticket_category_draft_assignment_pkey PRIMARY KEY (map_id);



ALTER TABLE ONLY ticket_category_assignment
    ADD CONSTRAINT ticket_category_assignment_pkey PRIMARY KEY (map_id);
...
ALTER TABLE ONLY lookup_ticket_cause
    ADD CONSTRAINT lookup_ticket_cause_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_ticket_resolution
    ADD CONSTRAINT lookup_ticket_resolution_pkey PRIMARY KEY (code);



ALTER TABLE ONLY ticket_defect
    ADD CONSTRAINT ticket_defect_pkey PRIMARY KEY (defect_id);



ALTER TABLE ONLY lookup_ticket_state
    ADD CONSTRAINT lookup_ticket_state_pkey PRIMARY KEY (code);
...
ALTER TABLE ONLY campaign_group_map
    ADD CONSTRAINT campaign_group_map_pkey PRIMARY KEY (map_id);
...
ALTER TABLE ONLY lookup_ticket_task_category
    ADD CONSTRAINT lookup_ticket_task_category_pkey PRIMARY KEY (code);
...
ALTER TABLE ONLY action_plan_category
    ADD CONSTRAINT action_plan_category_pkey PRIMARY KEY (id);



ALTER TABLE ONLY action_plan_category_draft
    ADD CONSTRAINT action_plan_category_draft_pkey PRIMARY KEY (id);



ALTER TABLE ONLY action_plan_constants
    ADD CONSTRAINT action_plan_constants_pkey PRIMARY KEY (map_id);



ALTER TABLE ONLY action_plan_editor_lookup
    ADD CONSTRAINT action_plan_editor_lookup_pkey PRIMARY KEY (id);



ALTER TABLE ONLY action_plan
    ADD CONSTRAINT action_plan_pkey PRIMARY KEY (plan_id);



ALTER TABLE ONLY action_phase
    ADD CONSTRAINT action_phase_pkey PRIMARY KEY (phase_id);



ALTER TABLE ONLY lookup_duration_type
    ADD CONSTRAINT lookup_duration_type_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_step_actions
    ADD CONSTRAINT lookup_step_actions_pkey PRIMARY KEY (code);



ALTER TABLE ONLY lookup_step_actions
    ADD CONSTRAINT lookup_step_actions_constant_id_key UNIQUE (constant_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT action_step_pkey PRIMARY KEY (step_id);



ALTER TABLE ONLY step_action_map
    ADD CONSTRAINT step_action_map_pkey PRIMARY KEY (map_id);



ALTER TABLE ONLY action_plan_work
    ADD CONSTRAINT action_plan_work_pkey PRIMARY KEY (plan_work_id);



ALTER TABLE ONLY action_plan_work_notes
    ADD CONSTRAINT action_plan_work_notes_pkey PRIMARY KEY (note_id);



ALTER TABLE ONLY action_phase_work
    ADD CONSTRAINT action_phase_work_pkey PRIMARY KEY (phase_work_id);



ALTER TABLE ONLY action_item_work
    ADD CONSTRAINT action_item_work_pkey PRIMARY KEY (item_work_id);



ALTER TABLE ONLY action_item_work_notes
    ADD CONSTRAINT action_item_work_notes_pkey PRIMARY KEY (note_id);



ALTER TABLE ONLY action_step_lookup
    ADD CONSTRAINT action_step_lookup_pkey PRIMARY KEY (code);



ALTER TABLE ONLY action_item_work_selection
    ADD CONSTRAINT action_item_work_selection_pkey PRIMARY KEY (selection_id);



ALTER TABLE ONLY ticket_category_plan_map
    ADD CONSTRAINT ticket_category_plan_map_pkey PRIMARY KEY (map_id);



ALTER TABLE ONLY ticket_category_draft_plan_map
    ADD CONSTRAINT ticket_category_draft_plan_map_pkey PRIMARY KEY (map_id);
...
ALTER TABLE ONLY netapp_contractexpiration
    ADD CONSTRAINT netapp_contractexpiration_pkey PRIMARY KEY (expiration_id);
...
ALTER TABLE ONLY "access"
    ADD CONSTRAINT "$1" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);
...
ALTER TABLE ONLY lookup_sub_segment
    ADD CONSTRAINT "$1" FOREIGN KEY (segment_id) REFERENCES lookup_segments(code);
...
ALTER TABLE ONLY organization
    ADD CONSTRAINT "$4" FOREIGN KEY (source) REFERENCES lookup_contact_source(code);



ALTER TABLE ONLY organization
    ADD CONSTRAINT "$5" FOREIGN KEY (rating) REFERENCES lookup_contact_rating(code);



ALTER TABLE ONLY organization
    ADD CONSTRAINT "$6" FOREIGN KEY (segment_id) REFERENCES lookup_segments(code);



ALTER TABLE ONLY organization
    ADD CONSTRAINT "$7" FOREIGN KEY (sub_segment_id) REFERENCES lookup_sub_segment(code);



ALTER TABLE ONLY organization
    ADD CONSTRAINT "$8" FOREIGN KEY (account_size) REFERENCES lookup_account_size(code);



ALTER TABLE ONLY organization
    ADD CONSTRAINT "$9" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);
...
ALTER TABLE ONLY contact
    ADD CONSTRAINT "$12" FOREIGN KEY (industry_temp_code) REFERENCES lookup_industry(code);



ALTER TABLE ONLY contact
    ADD CONSTRAINT "$13" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);
...
ALTER TABLE ONLY contact_textmessageaddress
    ADD CONSTRAINT "$2" FOREIGN KEY (textmessageaddress_type) REFERENCES lookup_textmessage_types(code);
...
ALTER TABLE ONLY import
    ADD CONSTRAINT "$3" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);



ALTER TABLE ONLY import
    ADD CONSTRAINT "$4" FOREIGN KEY (rating) REFERENCES lookup_contact_rating(code);
...
ALTER TABLE ONLY user_group_map
    ADD CONSTRAINT "$2" FOREIGN KEY (group_id) REFERENCES user_group(group_id);
...
ALTER TABLE ONLY custom_list_view
    ADD CONSTRAINT "$1" FOREIGN KEY (editor_id) REFERENCES custom_list_view_editor(editor_id);



ALTER TABLE ONLY custom_list_view_field
    ADD CONSTRAINT "$1" FOREIGN KEY (view_id) REFERENCES custom_list_view(view_id);
...
ALTER TABLE ONLY opportunity_header
    ADD CONSTRAINT "$5" FOREIGN KEY (access_type) REFERENCES lookup_access_types(code);



ALTER TABLE ONLY opportunity_header
    ADD CONSTRAINT "$6" FOREIGN KEY (manager) REFERENCES "access"(user_id);



ALTER TABLE ONLY opportunity_header
    ADD CONSTRAINT "$7" FOREIGN KEY (contact_org_id) REFERENCES organization(org_id);



ALTER TABLE ONLY opportunity_header
    ADD CONSTRAINT "$8" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);
...
ALTER TABLE ONLY opportunity_component_log
    ADD CONSTRAINT "$1" FOREIGN KEY (component_id) REFERENCES opportunity_component(id);



ALTER TABLE ONLY opportunity_component_log
    ADD CONSTRAINT "$2" FOREIGN KEY (header_id) REFERENCES opportunity_header(opp_id);
...
ALTER TABLE ONLY opportunity_component_log
    ADD CONSTRAINT "$4" FOREIGN KEY ("owner") REFERENCES "access"(user_id);
...
ALTER TABLE ONLY projects
    ADD CONSTRAINT "$4" FOREIGN KEY (approvalby) REFERENCES "access"(user_id);
...
ALTER TABLE ONLY project_issues
    ADD CONSTRAINT "$4" FOREIGN KEY (category_id) REFERENCES project_issues_categories(category_id);
...
ALTER TABLE ONLY asset
    ADD CONSTRAINT "$13" FOREIGN KEY (parent_id) REFERENCES asset(asset_id);



ALTER TABLE ONLY asset
    ADD CONSTRAINT "$14" FOREIGN KEY (vendor_code) REFERENCES lookup_asset_vendor(code);



ALTER TABLE ONLY asset
    ADD CONSTRAINT "$15" FOREIGN KEY (manufacturer_code) REFERENCES lookup_asset_manufacturer(code);



ALTER TABLE ONLY asset_materials_map
    ADD CONSTRAINT "$1" FOREIGN KEY (asset_id) REFERENCES asset(asset_id);



ALTER TABLE ONLY asset_materials_map
    ADD CONSTRAINT "$2" FOREIGN KEY (code) REFERENCES lookup_asset_materials(code);
...
ALTER TABLE ONLY ticket_category_draft_assignment
    ADD CONSTRAINT "$1" FOREIGN KEY (category_id) REFERENCES ticket_category_draft(id);



ALTER TABLE ONLY ticket_category_draft_assignment
    ADD CONSTRAINT "$2" FOREIGN KEY (department_id) REFERENCES lookup_department(code);



ALTER TABLE ONLY ticket_category_draft_assignment
    ADD CONSTRAINT "$3" FOREIGN KEY (assigned_to) REFERENCES "access"(user_id);



ALTER TABLE ONLY ticket_category_draft_assignment
    ADD CONSTRAINT "$4" FOREIGN KEY (group_id) REFERENCES user_group(group_id);



ALTER TABLE ONLY ticket_category_assignment
    ADD CONSTRAINT "$1" FOREIGN KEY (category_id) REFERENCES ticket_category(id);
...
ALTER TABLE ONLY order_payment
    ADD CONSTRAINT "$2" FOREIGN KEY (payment_method_id) REFERENCES lookup_payment_methods(code);
...
ALTER TABLE ONLY order_payment
    ADD CONSTRAINT "$5" FOREIGN KEY (order_item_id) REFERENCES order_product(item_id);



ALTER TABLE ONLY order_payment
    ADD CONSTRAINT "$6" FOREIGN KEY (history_id) REFERENCES customer_product_history(history_id);
...
ALTER TABLE ONLY contact_message
    ADD CONSTRAINT "$1" FOREIGN KEY (message_id) REFERENCES message(id);



ALTER TABLE ONLY contact_message
    ADD CONSTRAINT "$2" FOREIGN KEY (received_from) REFERENCES contact(contact_id);



ALTER TABLE ONLY contact_message
    ADD CONSTRAINT "$3" FOREIGN KEY (received_by) REFERENCES "access"(user_id);
...
ALTER TABLE ONLY campaign_group_map
    ADD CONSTRAINT "$2" FOREIGN KEY (user_group_id) REFERENCES user_group(group_id);
...
ALTER TABLE ONLY task
    ADD CONSTRAINT "$7" FOREIGN KEY (ticket_task_category_id) REFERENCES lookup_ticket_task_category(code);
...
ALTER TABLE ONLY tasklink_ticket
    ADD CONSTRAINT "$3" FOREIGN KEY (category_id) REFERENCES lookup_ticket_task_category(code);
...
ALTER TABLE ONLY document_store_user_member
    ADD CONSTRAINT "$6" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);
...
ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$20" FOREIGN KEY (user_group_id) REFERENCES user_group(group_id);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$21" FOREIGN KEY (cause_id) REFERENCES lookup_ticket_cause(code);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$22" FOREIGN KEY (resolution_id) REFERENCES lookup_ticket_resolution(code);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$23" FOREIGN KEY (defect_id) REFERENCES ticket_defect(defect_id);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$24" FOREIGN KEY (escalation_level) REFERENCES lookup_ticket_escalation(code);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$25" FOREIGN KEY (resolvedby) REFERENCES "access"(user_id);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$26" FOREIGN KEY (resolvedby_department_code) REFERENCES lookup_department(code);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$27" FOREIGN KEY (state_id) REFERENCES lookup_ticket_state(code);



ALTER TABLE ONLY ticket
    ADD CONSTRAINT "$28" FOREIGN KEY (site_id) REFERENCES lookup_site_id(code);



ALTER TABLE ONLY ticketlog
    ADD CONSTRAINT "$8" FOREIGN KEY (escalation_code) REFERENCES lookup_ticket_escalation(code);



ALTER TABLE ONLY ticketlog
    ADD CONSTRAINT "$9" FOREIGN KEY (state_id) REFERENCES lookup_ticket_state(code);



ALTER TABLE ONLY quote_entry
    ADD CONSTRAINT "$11" FOREIGN KEY (product_id) REFERENCES product_catalog(product_id);



ALTER TABLE ONLY quote_entry
    ADD CONSTRAINT "$12" FOREIGN KEY (customer_product_id) REFERENCES customer_product(customer_product_id);



ALTER TABLE ONLY quote_entry
    ADD CONSTRAINT "$13" FOREIGN KEY (opp_id) REFERENCES opportunity_header(opp_id);
...
ALTER TABLE ONLY action_plan_editor_lookup
    ADD CONSTRAINT "$2" FOREIGN KEY (constant_id) REFERENCES action_plan_constants(map_id);
...
ALTER TABLE ONLY action_plan
    ADD CONSTRAINT "$3" FOREIGN KEY (cat_code) REFERENCES action_plan_category(id);



ALTER TABLE ONLY action_plan
    ADD CONSTRAINT "$4" FOREIGN KEY (subcat_code1) REFERENCES action_plan_category(id);



ALTER TABLE ONLY action_plan
    ADD CONSTRAINT "$5" FOREIGN KEY (subcat_code2) REFERENCES action_plan_category(id);



ALTER TABLE ONLY action_plan
    ADD CONSTRAINT "$6" FOREIGN KEY (subcat_code3) REFERENCES action_plan_category(id);



ALTER TABLE ONLY action_plan
    ADD CONSTRAINT "$7" FOREIGN KEY (link_object_id) REFERENCES action_plan_constants(map_id);
...
ALTER TABLE ONLY action_phase
    ADD CONSTRAINT "$1" FOREIGN KEY (parent_id) REFERENCES action_phase(phase_id);



ALTER TABLE ONLY action_phase
    ADD CONSTRAINT "$2" FOREIGN KEY (plan_id) REFERENCES action_plan(plan_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$1" FOREIGN KEY (parent_id) REFERENCES action_step(step_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$2" FOREIGN KEY (phase_id) REFERENCES action_phase(phase_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$3" FOREIGN KEY (duration_type_id) REFERENCES lookup_duration_type(code);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$4" FOREIGN KEY (category_id) REFERENCES custom_field_category(category_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$5" FOREIGN KEY (field_id) REFERENCES custom_field_info(field_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$6" FOREIGN KEY (role_id) REFERENCES role(role_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$7" FOREIGN KEY (department_id) REFERENCES lookup_department(code);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$8" FOREIGN KEY (group_id) REFERENCES user_group(group_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$9" FOREIGN KEY (action_id) REFERENCES lookup_step_actions(constant_id);



ALTER TABLE ONLY action_step
    ADD CONSTRAINT "$10" FOREIGN KEY (campaign_id) REFERENCES campaign(campaign_id);



ALTER TABLE ONLY step_action_map
    ADD CONSTRAINT "$1" FOREIGN KEY (constant_id) REFERENCES action_plan_constants(map_id);



ALTER TABLE ONLY step_action_map
    ADD CONSTRAINT "$2" FOREIGN KEY (action_constant_id) REFERENCES lookup_step_actions(constant_id);



ALTER TABLE ONLY action_plan_work
    ADD CONSTRAINT "$1" FOREIGN KEY (action_plan_id) REFERENCES action_plan(plan_id);



ALTER TABLE ONLY action_plan_work
    ADD CONSTRAINT "$2" FOREIGN KEY (assignedto) REFERENCES "access"(user_id);



ALTER TABLE ONLY action_plan_work
    ADD CONSTRAINT "$3" FOREIGN KEY (link_module_id) REFERENCES action_plan_constants(map_id);
...
ALTER TABLE ONLY action_plan_work
    ADD CONSTRAINT "$6" FOREIGN KEY (current_phase) REFERENCES action_phase(phase_id);



ALTER TABLE ONLY action_plan_work_notes
    ADD CONSTRAINT "$1" FOREIGN KEY (plan_work_id) REFERENCES action_plan_work(plan_work_id);



ALTER TABLE ONLY action_plan_work_notes
    ADD CONSTRAINT "$2" FOREIGN KEY (submittedby) REFERENCES "access"(user_id);
...
ALTER TABLE ONLY action_phase_work
    ADD CONSTRAINT "$2" FOREIGN KEY (action_phase_id) REFERENCES action_phase(phase_id);
...
ALTER TABLE ONLY action_item_work
    ADD CONSTRAINT "$1" FOREIGN KEY (phase_work_id) REFERENCES action_phase_work(phase_work_id);



ALTER TABLE ONLY action_item_work
    ADD CONSTRAINT "$2" FOREIGN KEY (action_step_id) REFERENCES action_step(step_id);
...
ALTER TABLE ONLY action_item_work
    ADD CONSTRAINT "$4" FOREIGN KEY (link_module_id) REFERENCES action_plan_constants(map_id);
...
ALTER TABLE ONLY action_item_work_notes
    ADD CONSTRAINT "$1" FOREIGN KEY (item_work_id) REFERENCES action_item_work(item_work_id);
...
ALTER TABLE ONLY action_step_lookup
    ADD CONSTRAINT "$1" FOREIGN KEY (step_id) REFERENCES action_step(step_id);



ALTER TABLE ONLY action_step_account_types
    ADD CONSTRAINT "$1" FOREIGN KEY (step_id) REFERENCES action_step(step_id);
...
ALTER TABLE ONLY action_item_work_selection
    ADD CONSTRAINT "$2" FOREIGN KEY (selection) REFERENCES action_step_lookup(code);



ALTER TABLE ONLY ticket_category_plan_map
    ADD CONSTRAINT "$1" FOREIGN KEY (plan_id) REFERENCES action_plan(plan_id);



ALTER TABLE ONLY ticket_category_plan_map
    ADD CONSTRAINT "$2" FOREIGN KEY (category_id) REFERENCES ticket_category(id);
...
ALTER TABLE ONLY ticket_category_draft_plan_map
    ADD CONSTRAINT "$2" FOREIGN KEY (category_id) REFERENCES ticket_category_draft(id);
...
ALTER TABLE ONLY knowledge_base
    ADD CONSTRAINT "$2" FOREIGN KEY (item_id) REFERENCES project_files(item_id);
...
ALTER TABLE ONLY netapp_contractexpiration_log
    ADD CONSTRAINT "$1" FOREIGN KEY (expiration_id) REFERENCES netapp_contractexpiration(expiration_id);
...
SELECT pg_catalog.setval('lookup_account_size_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_segments_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_sub_segment_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_title_code_seq', 1, false);
...
SELECT pg_catalog.setval('user_group_map_group_map_id_seq', 1, false);



SELECT pg_catalog.setval('custom_list_view_editor_editor_id_seq', 1, false);



SELECT pg_catalog.setval('custom_list_view_view_id_seq', 1, false);



SELECT pg_catalog.setval('custom_list_view_field_field_id_seq', 1, false);
...
SELECT pg_catalog.setval('opportunity_component_log_id_seq', 1, false);
...
SELECT pg_catalog.setval('lookup_asset_manufactu_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_asset_vendor_code_seq', 1, false);
...
SELECT pg_catalog.setval('lookup_asset_materials_code_seq', 1, false);



SELECT pg_catalog.setval('asset_materials_map_map_id_seq', 1, false);
...
SELECT pg_catalog.setval('lookup_ticket_escalati_code_seq', 1, false);
...
SELECT pg_catalog.setval('ticket_category_draft_assignment_map_id_seq', 1, false);



SELECT pg_catalog.setval('ticket_category_assignment_map_id_seq', 1, false);
...
SELECT pg_catalog.setval('lookup_ticket_cause_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_ticket_resoluti_code_seq', 1, false);



SELECT pg_catalog.setval('ticket_defect_defect_id_seq', 1, false);



SELECT pg_catalog.setval('lookup_ticket_state_code_seq', 1, false);
...
SELECT pg_catalog.setval('contact_message_id_seq', 1, false);



SELECT pg_catalog.setval('campaign_group_map_map_id_seq', 1, false);
...
SELECT pg_catalog.setval('lookup_ticket_task_cat_code_seq', 1, false);
...
SELECT pg_catalog.setval('action_plan_category_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_category_draft_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_constants_map_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_editor_loo_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_plan_id_seq', 1, false);



SELECT pg_catalog.setval('action_phase_phase_id_seq', 1, false);



SELECT pg_catalog.setval('lookup_duration_type_code_seq', 1, false);



SELECT pg_catalog.setval('lookup_step_actions_code_seq', 1, false);



SELECT pg_catalog.setval('action_step_step_id_seq', 1, false);



SELECT pg_catalog.setval('step_action_map_map_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_work_plan_work_id_seq', 1, false);



SELECT pg_catalog.setval('action_plan_work_notes_note_id_seq', 1, false);



SELECT pg_catalog.setval('action_phase_work_phase_work_id_seq', 1, false);



SELECT pg_catalog.setval('action_item_work_item_work_id_seq', 1, false);



SELECT pg_catalog.setval('action_item_work_notes_note_id_seq', 1, false);



SELECT pg_catalog.setval('action_step_lookup_code_seq', 1, false);



SELECT pg_catalog.setval('action_item_work_selection_selection_id_seq', 1, false);



SELECT pg_catalog.setval('ticket_category_plan_map_map_id_seq', 1, false);



SELECT pg_catalog.setval('ticket_category_draft_plan_map_map_id_seq', 1, false);



SELECT pg_catalog.setval('knowledge_base_kb_id_seq', 1, false);



SELECT pg_catalog.setval('netapp_contractexpiration_expiration_id_seq', 1, false);

...
CREATE TABLE sites(
    ...
    vhost VARGRAPHIC(255) DEFAULT '' NOT NULL,
    dbhost VARGRAPHIC(255) DEFAULT '' NOT NULL,
    dbname VARGRAPHIC(255) DEFAULT '' NOT NULL,
    dbport INTEGER DEFAULT 50000 NOT NULL,
    dbuser VARGRAPHIC(255) DEFAULT '' NOT NULL,
    dbpw VARGRAPHIC(255) DEFAULT '' NOT NULL,
    driver VARGRAPHIC(255) DEFAULT '' NOT NULL,
    code VARGRAPHIC(255),

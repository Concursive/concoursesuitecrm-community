...
-- INSERTS
--UPDATE [business_process_component_parameter] SET [param_value]='The following ticket in Centric CRM has been assigned to you:'+CHAR(10)+''+CHAR(10)+'--- Ticket Details ---'+CHAR(10)+''+CHAR(10)+'Ticket # ${this.paddedId}'+CHAR(10)+'Priority: ${ticketPriorityLookup.description}'+CHAR(10)+'Severity: ${ticketSeverityLookup.description}'+CHAR(10)+'Issue: ${this.problem}'+CHAR(10)+''+CHAR(10)+'Assigned By: ${ticketModifiedByContact.nameFirstLast}'+CHAR(10)+'Comment: ${this.comment}'+CHAR(10)+'' WHERE [id]=12
--UPDATE [business_process_component_parameter] SET [param_value]='** This is an automated message **'+CHAR(10)+''+CHAR(10)+'The following tickets in Centric CRM are unassigned and need attention:'+CHAR(10)+''+CHAR(10)+'' WHERE [id]=22
...
--UPDATE [business_process_component_parameter] SET [param_value]='The following ticket in Centric CRM has been closed:'+CHAR(10)+''+CHAR(10)+'--- Ticket Details ---'+CHAR(10)+''+CHAR(10)+'Ticket # ${this.paddedId}'+CHAR(10)+'Priority: ${ticketPriorityLookup.description}'+CHAR(10)+'Severity: ${ticketSeverityLookup.description}'+CHAR(10)+'Issue: ${this.problem}'+CHAR(10)+''+CHAR(10)+'Comment: ${this.comment}'+CHAR(10)+''+CHAR(10)+'Closed by: ${ticketModifiedByContact.nameFirstLast}'+CHAR(10)+''+CHAR(10)+'Solution: ${this.solution}'+CHAR(10)+'' WHERE [id]=6
...
--UPDATE [business_process_parameter_library] SET [default_value]='** This is an automated message **'+CHAR(10)+''+CHAR(10)+'The following tickets in Centric CRM are unassigned and need attention:'+CHAR(10)+''+CHAR(10)+'' WHERE [parameter_id]=22

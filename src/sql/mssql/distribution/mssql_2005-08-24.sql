...
UPDATE lookup_delivery_options SET description = 'Instant Message', enabled = 0 WHERE code = 7;
UPDATE lookup_delivery_options SET description = 'Secure Socket', enabled = 0 WHERE code = 8;
UPDATE lookup_delivery_options SET description = 'Broadcast', enabled = 1 WHERE code = 9;
UPDATE campaign SET send_method_id = 9 where send_method_id = 7;

-- Add a new column to the contact relation

...
ALTER TABLE action_plan_work_notes ALTER COLUMN submittedby INT NOT NULL;

ALTER TABLE action_item_work_notes ADD submittedby INTEGER REFERENCES access(user_id);
...
ALTER TABLE action_item_work_notes ALTER COLUMN submittedby INT NOT NULL;

...
ALTER TABLE contact ADD no_email BIT;
UPDATE contact SET no_email = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_email

ALTER TABLE contact ADD no_mail BIT;
UPDATE contact SET no_mail = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_mail;

ALTER TABLE contact ADD no_phone BIT;
UPDATE contact SET no_phone = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_phone

ALTER TABLE contact ADD no_textmessage BIT;
UPDATE contact SET no_textmessage = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_textmessage;

ALTER TABLE contact ADD no_im BIT;
UPDATE contact SET no_im = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_im;

ALTER TABLE contact ADD no_fax BIT;
UPDATE contact SET no_fax = 0;
ALTER TABLE contact ADD DEFAULT (0) FOR no_fax;

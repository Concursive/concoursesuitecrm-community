...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item)
 VALUES (2, 'tableList', 'com.darkhorseventures.cfsbase.SyncTableList', 12, 0);
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'userList', 'com.darkhorseventures.cfsbase.UserList', 50, 1, 
'CREATE TABLE users (
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'makeList', 'com.darkhorseventures.autoguide.base.MakeList', 70, 1, 
'CREATE TABLE make (
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'modelList', 'com.darkhorseventures.autoguide.base.ModelList', 100, 1, 
'CREATE TABLE model (
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'vehicleList', 'com.darkhorseventures.autoguide.base.VehicleList', 130, 1, 
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'accountList', 'com.darkhorseventures.cfsbase.OrganizationList', 170, 1, 
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'accountInventoryList', 'com.darkhorseventures.autoguide.base.InventoryList', 190, 1,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'optionList', 'com.darkhorseventures.autoguide.base.OptionList', 330, 1,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'inventoryOptionList', 'com.darkhorseventures.autoguide.base.InventoryOptionList', 350, 1,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'adTypeList', 'com.darkhorseventures.webutils.LookupList', 385, 1,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'adRunList', 'com.darkhorseventures.autoguide.base.AdRunList', 390, 1,
'CREATE TABLE ad_run (
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'inventory_picture', null, 410, 0,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'preferences', null, 440, 0,
...
INSERT INTO sync_table (system_id, element_name, mapped_class_name, order_id, sync_item, create_statement)
 VALUES (2, 'user_account', null, 460, 0,

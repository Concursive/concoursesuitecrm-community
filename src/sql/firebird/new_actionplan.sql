...
CREATE TABLE action_step (
  ...
  enabled CHAR(1) DEFAULT 'Y' NOT NULL,
  entered TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  allow_skip_to_here CHAR(1) DEFAULT 'N' NOT NULL,
  label VARCHAR(80),
  action_required CHAR(1) DEFAULT 'N' NOT NULL,
  ...
  allow_duplicate_recipient CHAR(1) DEFAULT 'N' NOT NULL,
  display_in_plan_list CHAR(1) DEFAULT 'N' NOT NULL,

...
CREATE TABLE web_layout (
  ...
  layout_constant INT NOT NULL UNIQUE,
...
CREATE TABLE web_style (
  style_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  style_constant INT NOT NULL UNIQUE,
...
CREATE TABLE web_site_log (
  site_log_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_tab (
  tab_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_page_version (
  page_version_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_page_group (
  page_group_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_tab_banner (
  tab_banner_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  tab_id INT REFERENCES web_tab(tab_id),
...
CREATE TABLE web_page (
  page_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_page_row (
  page_row_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_icelet (
  icelet_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE web_row_column (
  row_column_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,

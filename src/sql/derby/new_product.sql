...
CREATE TABLE product_catalog (
  ...
  sku VARCHAR(40),
  in_stock CHAR(1) NOT NULL DEFAULT '1',
...
-- Example: Integer, Double, CLOB, Timestamp
...
CREATE TABLE product_option_configurator (
  configurator_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  short_description CLOB,
  long_description CLOB,
...
CREATE TABLE product_option (
  ...
  short_description CLOB,
  long_description CLOB,
  allow_customer_configure CHAR(1) NOT NULL DEFAULT '0',
  allow_user_configure CHAR(1) NOT NULL DEFAULT '0',
...
CREATE TABLE product_option_map (
  product_option_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  product_id INTEGER NOT NULL REFERENCES product_catalog(product_id),
  option_id INTEGER NOT NULL REFERENCES product_option(option_id)
);

...
CREATE TABLE action_phase (
  phase_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE action_step (
  step_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  ...
  enabled CHAR(1) NOT NULL DEFAULT '1',
  entered TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  allow_skip_to_here CHAR(1) NOT NULL DEFAULT '0',
  label VARCHAR(80),
  action_required CHAR(1) NOT NULL DEFAULT '0',
...
CREATE TABLE action_plan_work (
  plan_work_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
...
CREATE TABLE action_phase_work (
  phase_work_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
  plan_work_id INTEGER NOT NULL REFERENCES action_plan_work(plan_work_id),
...
CREATE TABLE action_item_work (
  item_work_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE action_item_work_selection (
  selection_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  item_work_id INTEGER NOT NULL REFERENCES action_item_work(item_work_id),

...
ALTER TABLE ticket ADD est_resolution_date_timezone NVARCHAR2(255);
ALTER TABLE ticket ADD assigned_date_timezone NVARCHAR2(255);
ALTER TABLE ticket ADD resolution_date_timezone NVARCHAR2(255);
...
ALTER TABLE ticket ADD resolvable CHAR(1) DEFAULT 1 NOT NULL;
UPDATE ticket SET resolvable = 1 WHERE resolvable IS NULL;
